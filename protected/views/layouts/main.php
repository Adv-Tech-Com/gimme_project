...
<body>
	...
	<div class="container" id="page">
		...
		<div id="header">
			<div id="logo">
				<a href="/home/" class="none"><?php echo CHtml::encode(Yii::app()->user->company); ?></a>
			</div>
		</div>
	</div>
	<!-- header -->
	...
	<?php if(isset($this->breadcrumbs)):?>
		<?php
			if( Yii::app()->urlManager->ParseUrl(Yii::app()->request) == 'home') {
				...
				$this->widget ( 'zii.widgets.CBreadcrumbs', array (
						'homeLink' => CHtml::link('Home', array('/home')),
						'links' => $this->breadcrumbs
				) );
			}
