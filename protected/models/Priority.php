...
class Priority extends CActiveRecord {
	...
	public function rules() {
		...
		return array (
				...
				// searched.
				array (
						'priority_id, priority_name, priority_desc',
						'safe',
						'on' => 'search' 
				) 
		);
	...
	public function search() {
		...
		$criteria->compare ( 'priority_name', $this->priority_name, true );
		$criteria->compare ( 'priority_desc', $this->priority_desc, true );
