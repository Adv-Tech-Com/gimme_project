 ...
 *
 * A concrete class must implement {@link loadMessages} or override {@link
 * translateMessage}.
 *
 * @property string $language The language that the source messages are written
 *           in.
...
abstract class CMessageSource extends CApplicationComponent {
	/**
	 *
	 * @var boolean whether to force message translation when the source and
	 *      target languages are the same.
	 *      Defaults to false, meaning translation is only performed when source
	 *      and target languages are different.
	 * @since 1.1.4
	 */
	 ...
	 * the {@link getLanguage source message language}, messages will NOT be
	 * translated.
	 *
	 * If the message is not found in the translations, an {@link
	 ...
	 * @return string the translated message (or the original message if
...
/**
 * CMissingTranslationEvent represents the parameter for the {@link
 * CMessageSource::onMissingTranslation onMissingTranslation} event.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.i18n
 * @since 1.0
...
class CMissingTranslationEvent extends CEvent {
	...
	/**
	 *
	 * @var string the ID of the language that the message is to be translated
	 *      to
	 */
	public $language;
