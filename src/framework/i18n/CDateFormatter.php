 ...
 * predefined patterns which include 'full', 'long', 'medium' (default) and
 * 'short'.</li>
...
class CDateFormatter extends CComponent {
	/**
	 *
	 * @var array pattern characters mapping to the corresponding translator
	 *      methods
	 */
	 ...
	 * @return string formatted date time. Null if $time is null. (the null
	 *         value check is available since Yii 1.1.11)
	 */
	 ...
	 * The predefined pattern is determined based on the date pattern width and
	 * time pattern width.
	 * 
	 * @param mixed $timestamp
	 *        	UNIX timestamp or a string in strtotime format
	 * @param string $dateWidth
	 *        	width of the date pattern. It can be 'full', 'long', 'medium'
	 *        	and 'short'.
	 *        	If null, it means the date portion will NOT appear in the
	 *        	formatting result
	 * @param string $timeWidth
	 *        	width of the time pattern. It can be 'full', 'long', 'medium'
	 *        	and 'short'.
	 *        	If null, it means the time portion will NOT appear in the
	 *        	formatting result
	 ...
	 * "MM" will return two digits month number with necessary zero padding,
	 * e.g. 05;
	 ...
	 * "d" for non-padding, "dd" will always return 2 digits day numbers, e.g.
	 * 05.
	 * 
	 * @param string $pattern
	 *        	a pattern.
