 ...
 * @property CNumberFormatter $numberFormatter The number formatter for this
 *           locale.
 ...
 * @property array $weekDayNames The weekday names indexed by weekday values
 *           (0-6, 0 means Sunday, 1 Monday, etc.).
 ...
 * @property string $dateTimeFormat Datetime format, i.e., the order of date and
 *           time.
 * @property string $orientation The character orientation, which is either
...
class CLocale extends CComponent {
	/**
	 *
	 * @var string the directory that contains the locale data. If this property
	 *      is not set,
	 ...
	 * In canonical form, a locale ID consists of only underscores and
	 * lower-case letters.
	 * 
	 * @param string $id
	 ...
	 *        	whether the month name should be returned in stand-alone
	 *        	format
	 ...
	 *        	month name width. It can be 'wide', 'abbreviated' or 'narrow'.
	 * @param boolean $standAlone
	 *        	whether the month names should be returned in stand-alone
	 *        	format
	 ...
	 * @param string $width
	 *        	weekday name width. It can be 'wide', 'abbreviated' or
	 *        	'narrow'.
	 * @param boolean $standAlone
	 *        	whether the week day name should be returned in stand-alone
	 *        	format
	 ...
	 *
	 * @param string $width
	 *        	date format width. It can be 'full', 'long', 'medium' or
	 *        	'short'.
	 ...
	 *
	 * @param string $width
	 *        	time format width. It can be 'full', 'long', 'medium' or
	 *        	'short'.
	 * @return string date format
	 */
	 ...
	 * A language ID consists of only the first group of letters before an
	 * underscore or dash.
	 * 
	 * @param string $id
	 *        	the locale ID to be converted
	 ...
	 * A script ID consists of only the last four characters after an underscore
	 * or dash.
	 * 
	 * @param string $id
	 *        	the locale ID to be converted
	...
	public function getScriptID($id) {
		...
		if (($underscorePosition = strpos ( $id, '_' )) !== false) {
			$subTag = explode ( '_', $id );
			// script sub tags can be distigused from territory sub tags by
			// length
	 ...
	 * A territory ID consists of only the last two to three letter or digits
	 * after an underscore or dash.
	 * 
	 * @param string $id
	 *        	the locale ID to be converted
	...
	public function getTerritoryID($id) {
		...
		if (($underscorePosition = strpos ( $id, '_' )) !== false) {
			$subTag = explode ( '_', $id );
			// territory sub tags can be distigused from script sub tags by
			// length
	 ...
	 * @return string the localized name for the id specified. Null if data does
	 *         not exist.
	 * @since 1.1.9
	 */
	 ...
	 *
	 * @param string $id
	 *        	Unicode language identifier from IETF BCP 47. For example, the
	 *        	code "en_US" represents U.S. English and "en_GB" represents
	 *        	British English.
	 * @return string the local display name for the language. Null if the
	 ...
	 *
	 * @param string $id
	 *        	Unicode script identifier from IETF BCP 47. For example, the
	 *        	code "en_US" represents U.S. English and "en_GB" represents
	 *        	British English.
	 * @return string the local display name for the script. Null if the script
	 *         code does not exist.
	 * @since 1.1.9
	 */
	 ...
	 *
	 * @param string $id
	 *        	Unicode territory identifier from IETF BCP 47. For example,
	 *        	the code "en_US" represents U.S. English and "en_GB"
	 *        	represents British English.
	 * @return string the local display name for the territory. Null if the
