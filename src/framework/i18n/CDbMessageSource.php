 ...
 * 'Message' table
 * stores the translated messages. The name of these two tables can be
 ...
 *
 * @property CDbConnection $dbConnection The DB connection used for the message
 *           source.
 *          
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.i18n
...
class CDbMessageSource extends CMessageSource {
	...
	/**
	 *
	 * @var string the name of the source message table. Defaults to
	 *      'SourceMessage'.
	 */
	public $sourceMessageTable = 'SourceMessage';
	/**
	 *
	 * @var string the name of the translated message table. Defaults to
	 *      'Message'.
	 */
