 ...
 *
 * It provides the same functionality as {@link CFormatter}, but overrides all
 * the settings for
 * {@link booleanFormat}, {@link datetimeFormat} and {@link numberFormat} with
 * the values for the
 * current locale. Because of this you are not able to configure these
 * properties for CLocalizedFormatter directly.
 * Date and time format can be adjsuted by setting {@link dateFormat} and {@link
 * timeFormat}.
 *
 * It uses {@link CApplication::locale} by default but you can set a custom
 * locale by using {@link setLocale}-method.
 *
 * For a list of recognizable format types, and details on how to call the
 * formatter methods,
 * see {@link CFormatter} documentation.
 *
 * To replace the application component 'format', which is registered by {@link
 * CApplication} by default, you can
...
class CLocalizedFormatter extends CFormatter {
	...
	/**
	 *
	 * @var string the width of the date pattern. It can be 'full', 'long',
	 *      'medium' and 'short'. Defaults to 'medium'.
	 * @see CDateFormatter::formatDateTime()
	 */
	public $dateFormat = 'medium';
	/**
	 *
	 * @var string the width of the time pattern. It can be 'full', 'long',
	 *      'medium' and 'short'. Defaults to 'medium'.
	 * @see CDateFormatter::formatDateTime()
	 */
	...
	/**
	 * Formats the value as a date and time using the {@link locale}s date
	 * formatter.
	 * 
	 * @param mixed $value
	 *        	the value to be formatted
