...
/**
 * CMarkdownParser is a wrapper of {@link
 * http://michelf.com/projects/php-markdown/extra/ MarkdownExtra_Parser}.
 *
 ...
 * <ul>
 * <li>{@link http://daringfireball.net/projects/markdown/syntax official
 * markdown syntax}</li>
 * <li>{@link http://michelf.com/projects/php-markdown/extra/ markdown extra
 * syntax}</li>
 * </ul>
 *
 * @property string $defaultCssFile The default CSS file that is used to
...
class CMarkdownParser extends MarkdownExtra_Parser {
	...
	/**
	 *
	 * @var mixed the options to be passed to {@link http://htmlpurifier.org
	 *      HTML Purifier}.
	 *      This can be a HTMLPurifier_Config object, an array of directives
	...
	/**
	 *
	 * @return string the default CSS file that is used to highlight code
	 *         blocks.
	 */
	 ...
	 *        	the code block
	 * @return string the highlighted code block. Null if the code block does
	 *         not need to highlighted
	 */
	 ...
	 * @return string the user-entered highlighting options. Null if no option
	 *         is entered.
	 */
