...
class CPropertyValue {
	 ...
	 * then an array consisting of just the string will be returned. If the
	 * value
	 ...
	 * A value is a valid enumerable value if it is equal to the name of a
	 * constant
	 ...
	 *        	the enumerable class name (make sure it is included before
