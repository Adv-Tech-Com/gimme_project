 ...
 *
 * CDbTestCase provides database fixture management with the help of {@link
 * CDbFixtureManager}.
 ...
 * <code>$this->posts['first post']</code>. We can also retrieve an ActiveRecord
 * instance
 * corresponding to a fixture data row using <code>$this->posts('first
 * post')</code>.
 * Note, here 'first post' refers to a key to a row in the original fixture
 * data.
 *
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
abstract class CDbTestCase extends CTestCase {
	/**
	 *
	 * @var array a list of fixtures that should be loaded before each test
	 *      method executes.
	 *      The array keys are fixture names, and the array values are either AR
	 *      class names
	 *      or table names. If table names, they must begin with a colon
	 *      character (e.g. 'Post'
	 ...
	 * can be accessed in terms of a method call.
	 * 
	 * @param string $name
	 *        	method name
	 * @param string $params
	 ...
	 * @return CActiveRecord the ActiveRecord instance corresponding to the
	 *         specified alias in the named fixture.
	 *         False is returned if there is no such fixture or the record
	 *         cannot be found.
	 */
	 ...
	 * If you override this method, make sure the parent implementation is
	 * invoked.
