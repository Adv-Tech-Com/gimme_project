 ...
 *
 * @property CConsoleCommand $owner The owner model that this behavior is
 *           attached to.
 *          
 * @author Evgeny Blinov <e.a.blinov@gmail.com>
...
class CConsoleCommandBehavior extends CBehavior {
	 ...
	 * The default implementation returns 'onAfterConstruct', 'onBeforeValidate'
	 * and 'onAfterValidate' events and handlers.
	 ...
	 * corresponding event of the {@link CBehavior::owner owner}.
	 * 
