...
class CConsoleCommandEvent extends CEvent {
	 ...
	 *      If this property is set true by the event handler, the console
	 *      command action will quit after handling this event.
	 *      If false, which is the default, the normal execution cycles will
	 ...
	 *      This property is available in {@link CConsoleCommand::onAfterAction}
	 *      event and will be set to the exit code
	 *      returned by the console command action. You can set it to change
