...
class CConsoleCommandRunner extends CComponent {
	/**
	 *
	 * @var array list of all available commands (command name=>command
	 *      configuration).
	 ...
	 * 
	 * @param array $args
	 *        	list of user supplied parameters (including the entry script
	 *        	name and the command name).
	 * @return integer null exit code returned by the command.
	 *         if null is returned, application will not exit explicitly. See
	 *         also {@link CConsoleApplication::processRequest()}.
