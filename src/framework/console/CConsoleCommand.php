 ...
 *
 * It works like {@link CController} by parsing command line options and
 * dispatching
 ...
 * must be
 * prefixed with "action". The parameters to an action method are considered as
 * options
 * for that specific action. The action specified as {@link defaultAction} will
 * be invoked
 ...
 * following
 * action method will allow us to run a command with <code>yiic sitemap
 * --type=News</code>:
 * <pre>
 ...
 * @property string $help The command description. Defaults to 'Usage: php
 *           entry-script.php command-name'.
 * @property array $optionHelp The command option help information. Each array
 *           element describes
...
abstract class CConsoleCommand extends CComponent {
	 ...
	 * This method is invoked after a command object is created and initialized
	 * with configurations.
	 * You may override this method to further customize the command before it
	 * executes.
	 * 
	 * @since 1.1.6
	 */
	 ...
	 * @return integer application exit code, which is returned by the invoked
	 *         action. 0 if the action did not return anything.
	 ...
	 * @return integer application exit code (return value is available since
	 *         version 1.1.11)
	 */
	 ...
	 * @return array the action name, named options (name=>value), and unnamed
	 *         options
	 * @since 1.1.5
	 */
	 ...
	 * 
	 * @return string the command description. Defaults to 'Usage: php
	 *         entry-script.php command-name'.
	 */
	 ...
	 * The default implementation will return all available actions together
	 * with their
	 * corresponding option information.
	 * 
	 * @return array the command option help information. Each array element
	 *         describes
	 *         the help information for a single action.
	 * @since 1.1.5
	 */
	 ...
	 *        	The array keys are names displayed during the copy process,
	 *        	and array values are specifications
	 *        	for files to be copied. Each array value must be an array of
	 *        	the following structure:
	 *        	<ul>
	 *        	<li>source: required, the full path of the file/directory to
	 *        	be copied from</li>
	 *        	<li>target: required, the full path of the file/directory to
	 *        	be copied to</li>
	 *        	<li>callback: optional, the callback to be invoked when
	 *        	copying a file. The callback function
	 *        	should be declared as follows:
	 *        	<pre>
	 *        	function foo($source,$params)
	 *        	</pre>
	 *        	where $source parameter is the source file path, and the
	 *        	content returned
	 *        	by the function will be saved into the target file.</li>
	 *        	<li>params: optional, the parameters to be passed to the
	 *        	callback</li>
	 *        	</ul>
	 * @see buildFileList
	 */
	 ...
	 *        	be ignored in list building process. Argument available since
	 *        	1.1.11.
	 ...
	 *        	whether to return the rendering result instead of displaying
	 *        	it
	...
	/**
	 * Reads input via the readline PHP extension if that's available, or
	 * fgets() if readline is not installed.
	 *
	 * @param string $message
	 *        	to echo out before waiting for user input
	 * @param string $default
	 *        	the default string to be returned when user does not write
	 *        	anything.
	 *        	Defaults to null, means that default string is disabled. This
	 *        	parameter is available since version 1.1.11.
	 ...
	 *        	this value is returned if no selection is made. This parameter
	 *        	has been available since version 1.1.11.
