 ...
 *
 * The target email addresses may be specified via {@link setEmails emails}
 * property.
 * Optionally, you may set the email {@link setSubject subject}, the
 * {@link setSentFrom sentFrom} address and any additional {@link setHeaders
 * headers}.
 *
 * @property array $emails List of destination email addresses.
 * @property string $subject Email subject. Defaults to
 *           CEmailLogRoute::DEFAULT_SUBJECT.
...
class CEmailLogRoute extends CLogRoute {
	/**
	 *
	 * @var boolean set this property to true value in case log data you're
	 *      going to send through emails contains
	 ...
	 *        	If the value is a string, it is assumed to be line break
	 *        	separated headers.
	 * @since 1.1.4
	 */
