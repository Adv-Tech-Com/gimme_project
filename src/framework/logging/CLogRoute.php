 ...
 * to the destination. The filters include log level filter and log category
 * filter.
 *
 * To specify level filter, set {@link levels} property,
 * which takes a string of comma-separated desired level names (e.g. 'Error,
 * Debug').
 * To specify category filter, set {@link categories} property,
 * which takes a string of comma-separated desired category names (e.g.
 * 'System.Web, System.IO').
 *
...
abstract class CLogRoute extends CComponent {
	...
	/**
	 *
	 * @var string list of levels separated by comma or space. Defaults to
	 *      empty, meaning all levels.
	 */
	public $levels = '';
	/**
	 *
	 * @var mixed array of categories, or string list separated by comma or
	 *      space.
	...
	/**
	 *
	 * @var mixed the additional filter (eg {@link CLogFilter}) that can be
	 *      applied to the log messages.
	 *      The value of this property will be passed to {@link
	 *      Yii::createComponent} to create
	 *      a log filter object. As a result, this can be either a string
	 *      representing the
	 *      filter class name or an array representing the filter configuration.
	 *      In general, the log filter class should implement {@link ILogFilter}
	 *      interface.
	 *      If you want to apply multiple filters you can use {@link
	 *      CChainedLogFilter} to do so.
	 ...
	 *        	whether to process the logs after they are collected from the
	 *        	logger
	 */
