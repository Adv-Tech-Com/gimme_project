...
class CLogRouter extends CApplicationComponent {
	 ...
	 *        	the configuration for a single route and has the following
	 *        	array structure:
	 *        	<ul>
	 *        	<li>class: specifies the class name or alias for the route
	 *        	class.</li>
	 *        	<li>name-value pairs: configure the initial property values of
	 *        	the route.</li>
	 *        	</ul>
	 */
	 ...
	 * This method is an event handler to the {@link CApplication::onEndRequest}
	 * event.
	 * 
	 * @param CEvent $event
	 *        	event parameter
