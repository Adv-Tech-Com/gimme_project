...
class CWebLogRoute extends CLogRoute {
	/**
	 *
	 * @var boolean whether the log should be displayed in FireBug instead of
	 ...
	 *      Defaults to true.
	 *      This option should be used carefully, because an ajax call returns
	 *      all output as a result data.
	 *      For example if the ajax call expects a json type result any output
	 *      from the logger will cause ajax call to fail.
	 */
	public $ignoreAjaxInFireBug = true;
	/**
	 *
	 * @var boolean whether the log should be ignored in FireBug for Flash/Flex
	 *      calls. Defaults to true.
	 *      This option should be used carefully, because an Flash/Flex call
	 *      returns all output as a result data.
	 *      For example if the Flash/Flex call expects an XML type result any
	 *      output from the logger will cause Flash/Flex call to fail.
	 * @since 1.1.11
	 */
	public $ignoreFlashInFireBug = true;
	/**
	 *
	 * @var boolean whether the log should be collapsed by default in Firebug.
	 *      Defaults to false.
	 * @since 1.1.13.
	 */
	 ...
	 * 
	 * @param string $view
	 *        	the view name (file name without extension). The file is
