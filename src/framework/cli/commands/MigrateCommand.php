 ...
 * the yii-dbmigrations extension
 * ((https://github.com/pieterclaerhout/yii-dbmigrations),
...
class MigrateCommand extends CConsoleCommand {
	...
	/**
	 *
	 * @var string the directory that stores the migrations. This must be
	 *      specified
	 *      in terms of a path alias, and the corresponding directory must
	 *      exist.
	 *      Defaults to 'application.migrations' (meaning
	 *      'protected/migrations').
	 */
	public $migrationPath = 'application.migrations';
	/**
	 *
	 * @var string the name of the table for keeping applied migration
	 *      information.
	 *      This table will be automatically created if not exists. Defaults to
	 *      'tbl_migration'.
	 *      The table structure is: (version varchar(255) primary key,
	 *      apply_time integer)
	 */
	public $migrationTable = 'tbl_migration';
	/**
	 *
	 * @var string the application component ID that specifies the database
	 *      connection for
	 ...
	 *      This
	 *      must be specified in terms of a path alias (e.g.
	 ...
	 *      Defaults to true.
	 *      Set this to false when performing migration in a cron job or
	 *      background process.
	 */
