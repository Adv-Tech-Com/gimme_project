...
class CrudCommand extends CConsoleCommand {
	 ...
	 *      If this is false, it means functional test file should NOT be
	 *      generated.
	 */
	public $functionalTestPath;
	/**
	 *
	 * @var array list of actions to be created. Each action must be associated
	 *      with a template file with the same name.
	 */
...
EOD;
	 ...
	 * @return integer null zero application exit code for help or null on
	 *         success
	 */
