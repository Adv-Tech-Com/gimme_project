...
class CDirectoryCacheDependency extends CCacheDependency {
	/**
	 *
	 * @var string the directory whose change is used to determine if the
	 *      dependency has been changed.
	 *      If any of the files under the directory is changed, the dependency
	 ...
	 *      If the value is 0, it means checking the files directly under the
	 *      specified directory.
	 */
	 ...
	 * This method returns the modification timestamps for files under the
	 * directory.
	 * 
	 * @throws CException if {@link directory} is empty
	 * @return mixed the data needed to determine if dependency has been
	 *         changed.
	 */
	 ...
	 * This method may go recursively into subdirectories if {@link
	 * recursiveLevel} is not 0.
	 * 
	 * @param string $directory
	 *        	the directory name
	 * @param integer $level
	...
	/**
	 * Checks to see if the specified subdirectory should be checked for
	 * dependency.
	 * This method is invoked when dependency of the whole directory is being
	 * checked.
	 * By default, it always returns true, meaning the subdirectory should be
	 * checked.
	 * You may override this method to check only certain subdirectories.
	 * 
	 * @param string $directory
	 *        	the name of the subdirectory that may be checked for
	 *        	dependency.
