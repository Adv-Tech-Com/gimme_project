 ...
 *
 * To add dependencies to CChainedCacheDependency, use {@link getDependencies
 * Dependencies}
...
class CChainedCacheDependency extends CComponent implements ICacheDependency {
	 ...
	 *
	 * @param array $values
	 *        	list of dependency objects or configurations to be added to
	 *        	this chain.
	 *        	If a dependency is specified as a configuration, it must be an
	 *        	array that can be recognized
