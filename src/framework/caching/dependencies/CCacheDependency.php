 ...
 * @property mixed $dependentData The data used to determine if dependency has
 *           been changed.
...
class CCacheDependency extends CComponent implements ICacheDependency {
	 ...
	 *      If set to true, dependent data for this cache dependency will only
	 *      be generated once per request.
	 *      You can then use the same cache dependency for multiple separate
	 *      cache calls on the same page
	 ...
	 *         This data is available after {@link evaluateDependency} is
	 *         called.
	 */
