 ...
 * The {@link connectionID} property specifies the ID of a {@link CDbConnection}
 * application
...
class CDbCacheDependency extends CCacheDependency {
	...
	/**
	 *
	 * @var string the SQL statement whose result is used to determine if the
	 ...
	 * 
	 * @param string $sql
	 *        	the SQL statement whose result is used to determine if the
	 *        	dependency has been changed.
	 */
	 ...
	 * This method ensures that the database instance is set null because it
	 * contains resource handles.
	 * 
	 * @return array
	 */
