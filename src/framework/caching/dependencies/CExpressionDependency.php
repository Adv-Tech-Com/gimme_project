...
class CExpressionDependency extends CCacheDependency {
	/**
	 *
	 * @var string the PHP expression whose result is used to determine the
	 *      dependency.
	 *      The expression can also be a valid serializable PHP callback.
	 *      It will be passed with a parameter which is the dependency object
	 *      itself.
	 *     
	 ...
	 *        	the PHP expression whose result is used to determine the
	 *        	dependency.
	 */
