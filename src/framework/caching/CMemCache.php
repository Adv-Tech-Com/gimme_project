...
/**
 * CMemCache implements a cache application component based on {@link
 ...
 * for more details.
 *
 * CMemCache can also be used with {@link http://pecl.php.net/package/memcached
 * memcached}.
 * To do so, set {@link useMemcached} to be true.
 *
 * @property mixed $memCache The memcache instance (or memcached if {@link
 *           useMemcached} is true) used by this component.
 * @property array $servers List of memcache server configurations. Each element
 *           is a {@link CMemCacheServerConfiguration}.
 *          
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CMemCache extends CCache {
	/**
	 *
	 * @var boolean whether to use memcached or memcache as the underlying
	 *      caching extension.
	 *      If true {@link http://pecl.php.net/package/memcached memcached} will
	 *      be used.
	 *      If false {@link http://pecl.php.net/package/memcache memcache}. will
	 *      be used.
	 *      Defaults to false.
	 */
	 ...
	 * @return Memcache Memcached memcache instance (or memcached if {@link
	 *         useMemcached} is true) used by this component.
	 */
	...
	/**
	 *
	 * @return array list of memcache server configurations. Each element is a
	 *         {@link CMemCacheServerConfiguration}.
	 */
	 ...
	 *
	 * @param array $config
	 *        	list of memcache server configurations. Each element must be
	 *        	an array
...
class CMemCacheServerConfiguration extends CComponent {
	...
	/**
	 *
	 * @var integer value in seconds which will be used for connecting to the
	 *      server
	 */
	public $timeout = 15;
	/**
