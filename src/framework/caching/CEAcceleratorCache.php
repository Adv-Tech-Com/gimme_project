...
/**
 * CEAcceleratorCache implements a cache application module based on {@link
...
class CEAcceleratorCache extends CCache {
	 ...
	 * 
	 * @throws CException if eAccelerator extension is not loaded, is disabled
	 *         or the cache functions are not compiled in.
	 */
