 ...
 * configure
 * a 'cache' application component and he does not need to check if
 * Yii::app()->cache is null or not.
 * By replacing CDummyCache with some other cache component, one can quickly
 * switch from
...
class CDummyCache extends CApplicationComponent implements ICache, ArrayAccess {
	 ...
	 *      Defaults to {@link CApplication::getId() application ID}.
	 */
	public $keyPrefix;
