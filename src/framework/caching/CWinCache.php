...
/**
 * CWinCache implements a cache application component based on {@link
 * http://www.iis.net/expand/wincacheforphp WinCache}.
 *
...
class CWinCache extends CCache {
	 ...
	 * 
	 * @throws CException if WinCache extension is not loaded or user cache is
	 *         disabled
	 */
