 ...
 *
 * To specify the content of the portlet, override the {@link renderContent}
 * method, or insert the content code between the {@link
 ...
 * </pre>
 *
 * A portlet also has an optional {@link title}. One may also override {@link
 * renderDecoration}
 * to further customize the decorative display of a portlet (e.g. adding min/max
 * buttons).
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package zii.widgets
...
class CPortlet extends CWidget {
	/**
	 *
	 * @var string the tag name for the portlet container tag. Defaults to
	 *      'div'.
	 */
	public $tagName = 'div';
	/**
	...
	/**
	 *
	 * @var string the CSS class for the decoration container tag. Defaults to
	 *      'portlet-decoration'.
	 */
	public $decorationCssClass = 'portlet-decoration';
	/**
	 *
	 * @var string the CSS class for the portlet title tag. Defaults to
	 *      'portlet-title'.
	 */
	public $titleCssClass = 'portlet-title';
	/**
	 *
	 * @var string the CSS class for the content container tag. Defaults to
	 *      'portlet-content'.
	 */
	public $contentCssClass = 'portlet-content';
	/**
	 *
	 * @var boolean whether to hide the portlet when the body content is empty.
	 *      Defaults to true.
	 * @since 1.1.4
	 */
