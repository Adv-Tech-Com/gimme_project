 ...
 * footer cell.
 * Child classes may override {@link renderHeaderCellContent}, {@link
 * renderDataCellContent}
 * and {@link renderFooterCellContent} to customize how these cells are
 * rendered.
 *
...
abstract class CGridColumn extends CComponent {
	/**
	 *
	 * @var string the ID of this column. This value should be unique among all
	 *      grid view columns.
	...
	/**
	 *
	 * @var string a PHP expression that is evaluated for every data cell and
	 *      whose result
	 *      is used as the CSS class name for the data cell. In this expression,
	 ...
	 * This method is invoked by the grid view when it initializes itself before
	 * rendering.
	 ...
	 * This method may be overridden to customize the rendering of the header
	 * cell.
	 */
	 ...
	 * This method may be overridden to customize the rendering of the footer
	 * cell.
	 */
	 ...
	 * This method SHOULD be overridden to customize the rendering of the data
	 * cell.
	 * 
	 * @param integer $row
	 *        	the row number (zero-based)
