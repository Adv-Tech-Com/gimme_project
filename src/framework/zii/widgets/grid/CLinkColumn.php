 ...
 * its data cells.
 *
 * The {@link label} and {@link url} properties determine how each hyperlink
 * will be rendered.
 * The {@link labelExpression}, {@link urlExpression} properties may be used
 * instead if they are available.
...
class CLinkColumn extends CGridColumn {
	/**
	 *
	 * @var string the label to the hyperlinks in the data cells. Note that the
	 *      label will not
	 *      be HTML-encoded when rendering. This property is ignored if {@link
	 *      labelExpression} is set.
	 * @see labelExpression
	 */
	public $label = 'Link';
	/**
	...
	/**
	 *
	 * @var string the URL to the image. If this is set, an image link will be
	 *      rendered.
	 */
	public $imageUrl;
	/**
