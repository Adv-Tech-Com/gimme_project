 ...
 *
 * CJuiAccordion encapsulates the {@link http://jqueryui.com/accordion/ JUI
 * Accordion}
 * plugin.
 *
...
class CJuiAccordion extends CJuiWidget {
	 ...
	 *      Note that neither panel title nor panel content will be
	 *      HTML-encoded.
	 */
	public $panels = array ();
	/**
	 ...
	 *      title.
	 *      Note that if you make change to this template, you may also need to
	 *      adjust
