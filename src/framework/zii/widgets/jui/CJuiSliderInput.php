 ...
 * range.
 * In this mode, {@link attribute} and {@link maxAttribute} will define the
 * attribute
...
class CJuiSliderInput extends CJuiInputWidget {
	/**
	 *
	 * @var string the name of the container element that contains the slider.
	 *      Defaults to 'div'.
	 */
	public $tagName = 'div';
	/**
	 *
	 * @var integer determines the value of the slider, if there's only one
	 *      handle. If there is more than one handle,
	 *      determines the value of the first handle.
	 */
	public $value;
	/**
	 *
	 * @var string the name of the event where the input will be attached to the
	 *      slider. It
	 *      can be 'slide', 'stop' or 'change'. If you want to use 'slide' event
	 *      change $event property to 'change'.
	 */
	public $event = 'slide';
	/**
	 *
	 * @var string name of attribute for max value if slider is used in range
	 *      mode.
	 */
	public $maxAttribute;
	/**
	 *
	 * @var string the input name to be used for max value attribute when using
	 *      slider in range mode.
	...
	/**
	 *
	 * @var integer determines the max value of the slider, if there's two
	 *      handles (range mode). Ignored if there's
	 *      only one handle.
	 * @since 1.1.14
	 */
	public $maxValue;
	/**
	 *
	 * @var string the suffix to be appended to the ID of the max value input
	 *      element
