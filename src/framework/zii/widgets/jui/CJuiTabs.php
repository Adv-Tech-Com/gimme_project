...
class CJuiTabs extends CJuiWidget {
	 ...
	 *      The tab content can be either a string or an array. When it is an
	 *      array, it can
	 ...
	 *      </pre>
	 *      where the 'id' element is optional. The second format allows the tab
	 *      content
	 *      to be dynamically fetched from the specified URL via AJAX. The URL
	 *      can be either
	 *      a string or an array. If an array, it will be normalized into a URL
	 *      using {@link CHtml::normalizeUrl}.
	 */
	public $tabs = array ();
	/**
	 *
	 * @var string the name of the container element that contains all panels.
	 *      Defaults to 'div'.
	 */
	public $tagName = 'div';
	/**
	 ...
	 *      The token "{title}" in the template will be replaced with the panel
	 *      title and
	 *      the token "{url}" will be replaced with "#TabID" or with the url of
	 *      the ajax request.
	 */
	 ...
	 *      The token "{content}" in the template will be replaced with the
	 *      panel content
	 ...
	 * This method overrides the parent implementation by registering the cookie
	 * plugin when cookie option is used.
	 */
