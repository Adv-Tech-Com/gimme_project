...
class CJuiDatePicker extends CJuiInputWidget {
	/**
	 *
	 * @var string the locale ID (eg 'fr', 'de') for the language to be used by
	 *      the date picker.
	 *      If this property is not set, I18N will not be involved. That is, the
	 *      date picker will show in English.
	 *      You can force English language by setting the language attribute as
	 *      '' (empty string)
	 */
	public $language;
	/**
	...
	/**
	 *
	 * @var boolean If true, shows the widget as an inline calendar and the
	 *      input as a hidden field.
	 */
	public $flat = false;
