 ...
 *
 * CJuiSelectable encapsulates the {@link http://jqueryui.com/selectable/ JUI
 * Selectable}
 * plugin.
 *
...
class CJuiSelectable extends CJuiWidget {
	...
	/**
	 *
	 * @var string the name of the container element that contains all items.
	 *      Defaults to 'ol'.
	 */
	public $tagName = 'ol';
	/**
	 ...
	 *      The token "{content}" in the template will be replaced with the item
	 *      content,
