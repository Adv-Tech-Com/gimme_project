...
abstract class CJuiInputWidget extends CJuiWidget {
	 ...
	 *      The name can contain square brackets (e.g. 'name[1]') which is used
	 *      to collect tabular data input.
	 */
	public $attribute;
	/**
	 *
	 ...
	 * could be customized by specifying first and/or second parameter
	 * accordingly.
	 * 
	 * @param string $nameProperty
	 *        	class property name which holds element name to be used. This
	 *        	parameter
	 *        	is available since 1.1.14.
	 * @param string $attributeProperty
	 *        	class property name which holds model attribute name to be
	 *        	used. This
