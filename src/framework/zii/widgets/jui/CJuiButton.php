...
class CJuiButton extends CJuiInputWidget {
	/**
	 *
	 * @var string The button type (possible types: submit, button, link, radio,
	 *      checkbox, buttonset).
	 ...
	 *      Used when a buttonType "link" is selected.
	 *      See {@link normalizeUrl} for more details about how to specify this
	 *      parameter.
	 */
	public $url = null;
	/**
	 *
	 * @var mixed The value of the current item. Used only for "radio" and
	 *      "checkbox"
	 */
	public $value;
	/**
	...
	/**
	 *
	 * @var string The javascript function to be raised when this item is
	 *      clicked (client event).
	 */
	public $onclick;
