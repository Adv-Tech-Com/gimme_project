 ...
 *
 * CJuiDroppable encapsulates the {@link http://jqueryui.com/droppable/ JUI
 * Droppable}
 * plugin.
 *
 ...
 * the {@link http://api.jqueryui.com/droppable/ JUI Droppable API}
 * documentation
...
class CJuiDroppable extends CJuiWidget {
	/**
	 *
	 * @var string the HTML tag name of the Droppable element. Defaults to
	 *      'div'.
	 */
	public $tagName = 'div';
