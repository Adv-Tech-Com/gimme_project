 ...
 *
 * CJuiAutoComplete encapsulates the {@link http://jqueryui.com/autocomplete/
 * JUI
 * autocomplete} plugin.
 *
...
class CJuiAutoComplete extends CJuiInputWidget {
	/**
	 *
	 * @var mixed the entries that the autocomplete should choose from. This can
	 *      be
	 *      <ul>
	 *      <li>an Array with local data</li>
	 *      <li>a String, specifying a URL that returns JSON data as the
	 *      entries.</li>
	 *      <li>a javascript callback. Please make sure you wrap the callback
	 *      with
	 ...
	 *      CHtml::normalizeUrl() will be applied to this property to convert
	 *      the property
	 *      into a proper URL. When this property is set, the {@link source}
