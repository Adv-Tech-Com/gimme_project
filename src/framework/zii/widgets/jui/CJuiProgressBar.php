 ...
 * the {@link http://api.jqueryui.com/progressbar/ JUI ProgressBar}
 * documentation
...
class CJuiProgressBar extends CJuiWidget {
	/**
	 *
	 * @var string the name of the container element that contains the progress
	 *      bar. Defaults to 'div'.
	 */
	public $tagName = 'div';
	/**
	 *
	 * @var integer the percentage of the progress. This must be an integer
	 *      between 0 and 100. Defaults to 0.
	 */
	public $value = 0;
