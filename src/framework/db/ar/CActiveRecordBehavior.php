 ...
 * {@link CActiveRecord}.
 * Compared with {@link CModelBehavior}, CActiveRecordBehavior attaches to more
 * events
 * that are only defined by {@link CActiveRecord}.
 *
 * @property CActiveRecord $owner The owner AR that this behavior is attached
 *           to.
 *          
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CActiveRecordBehavior extends CModelBehavior {
	 ...
	 * If you override this method, make sure you merge the parent result to the
	 * return value.
	 * 
	 ...
	 * Override this method and make it public if you want to handle the
	 * corresponding
	 * event of the {@link CBehavior::owner owner}.
	 * You may set {@link CModelEvent::isValid} to be false to quit the saving
	 * process.
	 * 
	 ...
	 * corresponding event
	 * of the {@link CBehavior::owner owner}.
	 * You may set {@link CModelEvent::isValid} to be false to quit the deletion
	 * process.
	 * 
	 * @param CEvent $event
	 *        	event parameter
