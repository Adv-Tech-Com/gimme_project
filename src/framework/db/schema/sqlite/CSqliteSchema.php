...
class CSqliteSchema extends CDbSchema {
	 ...
	 * 
	 * @param string $schema
	 *        	the schema of the tables. This is not used for sqlite
	 *        	database.
	 ...
	 * Because SQLite does not support dropping a DB column, calling this method
	 ...
	 * Because SQLite does not support renaming a DB column, calling this method
	 * will throw an exception.
	 * 
	 * @param string $table
	 ...
	 * table.
	 * Because SQLite does not support adding foreign key to an existing table,
	 ...
	 * Because SQLite does not support dropping a foreign key constraint,
	 * calling this method will throw an exception.
	 * 
	 * @param string $name
	 ...
	 * Because SQLite does not support altering a DB column, calling this method
	 * will throw an exception.
	 * 
	 * @param string $table
	 ...
	 * table.
	 * Because SQLite does not support adding a primary key on an existing table
	 ...
	 * existing table.
	 * Because SQLite does not support dropping a primary key from an existing
