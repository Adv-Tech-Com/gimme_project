...
class CDbTableSchema extends CComponent {
	...
	/**
	 *
	 * @var string raw name of this table. This is the quoted version of table
	 *      name with optional schema name. It can be directly used in SQLs.
	 */
	public $rawName;
	/**
	 *
	 * @var string array key name of this table. If composite key, an array of
	...
	/**
	 *
	 * @var array foreign keys of this table. The array is indexed by column
	 *      name. Each value is an array of foreign table name and foreign
	 *      column name.
	 */
	 ...
	 * This is a convenient method for retrieving a named column even if it does
	 * not exist.
	 * 
	 * @param string $name
	 *        	column name
	 * @return CDbColumnSchema metadata of the named column. Null if the named
