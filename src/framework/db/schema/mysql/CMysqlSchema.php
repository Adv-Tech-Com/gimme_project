...
class CMysqlSchema extends CDbSchema {
	 ...
	 * @param string $name
	 *        	table name
	 * @return CMysqlTableSchema driver dependent table metadata. Null if the
	 ...
	 * This method overrides parent implementation in order to create a MySQL
	 * specific command builder
	 * 
	 ...
	 * 
	 * @param string $name
	 *        	not used in the MySQL syntax, the primary key is always called
