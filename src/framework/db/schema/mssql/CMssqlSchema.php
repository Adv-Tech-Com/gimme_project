...
class CMssqlSchema extends CDbSchema {
	 ...
	 * @param string $name
	 *        	table name
	 * @return CMssqlTableSchema driver dependent table metadata. Null if the
	 ...
	 * @param CMssqlTableSchema $table
	 *        	table
	 * @return mixed primary keys (null if no pk, string if only 1 column pk, or
	 *         array if composite pk)
	 */
...
EOD;
	 ...
	 * This method overrides parent implementation in order to create a MSSQL
