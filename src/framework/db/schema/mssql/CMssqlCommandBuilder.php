...
class CMssqlCommandBuilder extends CDbCommandBuilder {
	 ...
	 * Override parent implementation to remove the order clause of criteria if
	 * it exists
	 * 
	 ...
	 * Override parent implementation because mssql don't want to update an
	 * identity column
	 * 
	 * @param CDbTableSchema $table
	 *        	the table metadata
	 ...
	 *
	 * Overrides parent implementation. Alters the sql to apply $limit and
	 * $offset.
	 ...
	 * query
	 * may be malformed for complex queries.</b> The following restrictions
	 * apply
	 *
	 * <ul>
	 * <li>
	 * In particular, <b>commas</b> should <b>NOT</b>
	 * be used as part of the ordering expression or identifier. Commas must
	 * only be
	 * used for separating the ordering clauses.
	 * </li>
	 * <li>
	 * In the ORDER BY clause, the column name should NOT be be qualified
	 * with a table name or view name. Alias the column names or use column
	 * index.
	 * </li>
	 * <li>
