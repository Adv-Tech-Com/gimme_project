 ...
 * It provides workaround of the improperly implemented functionalities of PDO
 * SQLSRV driver.
 *
 * @author Timur Ruziev <resurtm@gmail.com>
...
class CMssqlSqlsrvPdoAdapter extends PDO {
	 ...
	 * SQLSRV driver supports PDO::lastInsertId() with one peculiarity: when
	 * $sequence's value is null or empty
	 * string it returns empty string. But when parameter is not specified at
