...
class COciSchema extends CDbSchema {
	 ...
	 *
	 * @param string $table
	 *        	table name with optional schema name prefix, uses default
...
EOD;
	 ...
	 *
	 * Note, behavior of this method has changed since 1.1.14 release. Please
	 * refer to the following
	 * issue for more details: {@link
