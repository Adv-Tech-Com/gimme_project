...
class CDbColumnSchema extends CComponent {
	...
	/**
	 *
	 * @var string comment of this column. Default value is empty string which
	 *      means that no comment
	 *      has been set for the column. Null value means that RDBMS does not
	 *      support column comments
	 *      at all (SQLite) or comment retrieval for the active RDBMS is not yet
	 ...
	 * This sets up the column's PHP type, size, precision, scale as well as
	 * default value.
	 * 
	 * @param string $dbType
