 ...
 *
 * Within each migration, the {@link up} method contains the logic for
 * "upgrading"
 * the database used in an application; while the {@link down} method contains
 * "downgrading"
 * logic. The "yiic migrate" command manages all available migrations in an
 * application.
 *
 * By overriding {@link safeUp} or {@link safeDown} methods instead of {@link
 * up} and {@link down}
 ...
 * data and schema.
 * For example, the {@link insert} method can be used to easily insert a row of
 * data into
 * a database table; the {@link createTable} method can be used to create a
 * database table.
 * Compared with the same methods in {@link CDbCommand}, these methods will
 * display extra
 * information showing the method parameters and execution time, which may be
 * useful when
 * applying migrations.
 *
 * @property CDbConnection $dbConnection The currently active database
 *           connection.
 *          
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.db
...
abstract class CDbMigration extends CComponent {
	 ...
	 * migration.
	 * Child classes may implement this method to provide actual migration
	 * logic.
	 * 
	 ...
	 * migration.
	 * Child classes may override this method if the corresponding migrations
	 * can be removed.
	 * 
	 * @return boolean Returning false means, the migration will not be applied.
	 */
	 ...
	 * This method contains the logic to be executed when applying this
	 * migration.
	 * This method differs from {@link up} in that the DB logic implemented here
	 * will
	 * be enclosed within a DB transaction.
	 * Child classes may implement this method instead of {@link up} if the DB
	 * logic
	 ...
	 * This method contains the logic to be executed when removing this
	 * migration.
	 * This method differs from {@link down} in that the DB logic implemented
	 * here will
	 * be enclosed within a DB transaction.
	 * Child classes may implement this method instead of {@link up} if the DB
	 * logic
	 ...
	 * By default, the 'db' application component will be returned and
	 * activated.
	 * You can call {@link setDbConnection} to switch to a different database
	 * connection.
	 * Methods such as {@link insert}, {@link createTable} will use this
	 * database connection
	 ...
	 * The database connection will be used by the methods such as {@link
	 * insert}, {@link createTable}.
	 * 
	 ...
	 * This method executes the specified SQL statement using {@link
	 * dbConnection}.
	 * 
	 * @param string $sql
	 *        	the SQL statement to be executed
	 * @param array $params
	 *        	input parameters (name=>value) for the SQL execution. See
	 *        	{@link CDbCommand::execute} for more details.
	 * @since 1.1.7
	 */
	 ...
	 *        	refer to {@link CDbCommand::where} on how to specify
	 *        	conditions.
	 * @param array $params
	 ...
	 * @param string $columns
	 *        	name of the column to utilise as primary key. If there are
