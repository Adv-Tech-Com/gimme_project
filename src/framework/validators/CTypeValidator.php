...
/**
 * CTypeValidator verifies if the attribute is of the type specified by {@link
 * type}.
 *
 ...
 *
 * Starting from version 1.1.7, we have a dedicated date validator {@link
 * CDateValidator}.
 ...
 * <ul>
 * <li>{type}: replaced with data type the attribute should be {@link
 * type}.</li>
 * </ul>
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CTypeValidator extends CValidator {
	/**
	 *
	 * @var string the data type that the attribute should be. Defaults to
	 *      'string'.
	 *      Valid values include 'string', 'integer', 'float', 'array', 'date',
	 *      'time' and 'datetime'.
	 */
	public $type = 'string';
	/**
	 *
	 * @var string the format pattern that the date value should follow.
	 *      Defaults to 'MM/dd/yyyy'.
	 *      Please see {@link CDateTimeParser} for details about how to specify
	 *      a date format.
	...
	/**
	 *
	 * @var string the format pattern that the time value should follow.
	 *      Defaults to 'hh:mm'.
	 *      Please see {@link CDateTimeParser} for details about how to specify
	 *      a time format.
	...
	/**
	 *
	 * @var string the format pattern that the datetime value should follow.
	 *      Defaults to 'MM/dd/yyyy hh:mm'.
	 *      Please see {@link CDateTimeParser} for details about how to specify
	 *      a datetime format.
	...
	/**
	 *
	 * @var boolean whether the actual PHP type of attribute value should be
	 *      checked.
	 *      Defaults to false, meaning that correctly formatted strings are
	 *      accepted for
