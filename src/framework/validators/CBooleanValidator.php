...
/**
 * CBooleanValidator validates that the attribute value is either {@link
 * trueValue} or {@link falseValue}.
 *
 ...
 * <ul>
 * <li>{true}: replaced with value representing the true status {@link
 * trueValue}.</li>
 * <li>{false}: replaced with value representing the false status {@link
 * falseValue}.</li>
 * </ul>
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CBooleanValidator extends CValidator {
	...
	/**
	 *
	 * @var boolean whether the comparison to {@link trueValue} and {@link
	 *      falseValue} is strict.
	 *      When this is true, the attribute value and type must both match
	 *      those of {@link trueValue} or {@link falseValue}.
