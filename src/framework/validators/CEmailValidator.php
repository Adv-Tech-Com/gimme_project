...
class CEmailValidator extends CValidator {
	...
	/**
	 *
	 * @var boolean whether to allow name in the email address (e.g. "Qiang Xue
	 ...
	 *      Defaults to false. To enable it, you need to make sure the PHP
	 *      function 'checkdnsrr'
	 *      exists in your PHP installation.
	 *      Please note that this check may fail due to temporary problems even
	 *      if email is deliverable.
	 */
	public $checkMX = false;
	/**
	 *
	 * @var boolean whether to check port 25 for the email address.
	 *      Defaults to false. To enable it, ensure that the PHP functions
	 *      'dns_get_record' and
	 ...
	 *      value is false which means that validation of emails containing IDN
	 *      will always fail.
	 * @since 1.1.13
	 */
