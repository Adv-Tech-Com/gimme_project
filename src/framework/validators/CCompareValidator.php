 ...
 *
 * When using the {@link message} property to define a custom error message, the
 * message
 * may contain additional placeholders that will be replaced with the actual
 * content. In addition
 * to the "{attribute}" placeholder, recognized by all validators (see {@link
 * CValidator}),
 * CCompareValidator allows for the following placeholders to be specified:
 * <ul>
 * <li>{compareValue}: replaced with the constant value being compared with
 * ({@link compareValue}).</li>
 * <li>{compareAttribute}: replaced with the label of the attribute being
 * compared with ({@link compareAttribute}).</li>
 * </ul>
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CCompareValidator extends CValidator {
	...
	/**
	 *
	 * @var boolean whether the comparison is strict (both value and type must
	 *      be the same.)
	 *      Defaults to false.
	 */
	public $strict = false;
	 ...
	 *      to false.
	 *      If this is true, it means the attribute is considered valid when it
	 *      is empty.
	 */
	 ...
	 *      <ul>
	 *      <li>'=' or '==': validates to see if the two values are equal. If
	 *      {@link strict} is true, the comparison
	 *      will be done in strict mode (i.e. checking value type as well).</li>
	 *      <li>'!=': validates to see if the two values are NOT equal. If
	 *      {@link strict} is true, the comparison
	 *      will be done in strict mode (i.e. checking value type as well).</li>
	 *      <li>'>': validates to see if the value being validated is greater
	 *      than the value being compared with.</li>
	 *      <li>'>=': validates to see if the value being validated is greater
	 *      than or equal to the value being compared with.</li>
	 *      <li>'<': validates to see if the value being validated is less than
	 *      the value being compared with.</li>
	 *      <li>'<=': validates to see if the value being validated is less than
	 *      or equal to the value being compared with.</li>
	 *      </ul>
	 */
	public $operator = '=';
