...
class CRangeValidator extends CValidator {
	...
	/**
	 *
	 * @var boolean whether the comparison is strict (both type and value must
	 *      be the same)
	 */
	public $strict = false;
	/**
	...
	/**
	 *
	 * @var boolean whether to invert the validation logic. Defaults to false.
	 *      If set to true,
	 *      the attribute value should NOT be among the list of values defined
	 *      via {@link range}.
	 * @since 1.1.5
	 *       
	 */
