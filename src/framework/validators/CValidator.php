 ...
 * This is used to match the 'on' parameter supplied when calling {@link
 * CModel::validate}.</li>
 * </ul>
 *
...
abstract class CValidator extends CComponent {
	...
	/**
	 *
	 * @var string the user-defined error message. Different validators may
	 *      define various
	 *      placeholders in the message that are to be replaced with actual
	 *      values. All validators
	 *      recognize "{attribute}" placeholder, which will be replaced with the
	 *      label of the attribute.
	 */
	public $message;
	/**
	 *
	 * @var boolean whether this validation rule should be skipped when there is
	 *      already a validation
	 ...
	 *      Each array value refers to a scenario name with the same name as its
	 *      array key.
	 */
	public $on;
	/**
	 ...
	 *      Please refer to {@link CActiveForm::enableClientValidation} for more
	 *      details about client-side validation.
	 * @since 1.1.7
	 */
	 ...
	 * @param CModel $object
	 *        	the data object being validated that may contain the inline
	 *        	validation method
	 * @param mixed $attributes
	 *        	list of attributes to be validated. This can be either an
	 *        	array of
	 *        	the attribute names or a string of comma-separated attribute
	 *        	names.
	 * @param array $params
	 ...
	 *        	meaning every attribute listed in {@link attributes} will be
	 *        	validated.
	 */
	 ...
	 * Do not override this method if the validator does not support client-side
	 * validation.
	 * Two predefined JavaScript variables can be used:
	 * <ul>
	 * <li>value: the value to be validated</li>
	 * <li>messages: an array used to hold the validation error messages for the
	 * value</li>
	 * </ul>
	 * 
	 * @param CModel $object
	 ...
	 * @param string $attribute
	 *        	the name of the attribute to be validated.
	 * @return string the client-side validation script. Null if the validator
	 ...
	 * scenario.
	 * A validator applies to a scenario as long as any of the following
	 * conditions is met:
	 * <ul>
	 ...
	 * Note that this method is different from PHP empty(). It will return false
	 * when the value is 0.
	 * 
	 * @param mixed $value
	 *        	the value to be checked
	 * @param boolean $trim
	 *        	whether to perform trimming before checking if the string is
