 ...
 * message,
 * CNumberValidator has a couple custom error messages you can set that
 * correspond to different
 * validation scenarios. To specify a custom message when the numeric value is
 * too big,
 ...
 * recognized by all
 * validators (see {@link CValidator}), CNumberValidator allows for the
 * following placeholders
 * to be specified:
 * <ul>
 * <li>{min}: when using {@link tooSmall}, replaced with the lower limit of the
 * number {@link min}.</li>
 * <li>{max}: when using {@link tooBig}, replaced with the upper limit of the
 * number {@link max}.</li>
 * </ul>
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CNumberValidator extends CValidator {
	/**
	 *
	 * @var boolean whether the attribute value can only be an integer. Defaults
	 *      to false.
	 */
	...
	/**
	 *
	 * @var integer float limit of the number. Defaults to null, meaning no
	 *      upper limit.
	 */
	public $max;
	/**
