...
class CInlineValidator extends CValidator {
	/**
	 *
	 * @var string the name of the validation method defined in the active
	 *      record class
	 */
	public $method;
	/**
	...
	/**
	 *
	 * @var string the name of the method that returns the client validation
	 *      code (See {@link clientValidateAttribute}).
	 */
	 ...
	 * calling the {@link clientValidate} method.
	 * In the client validation code, these variables are predefined:
	 * <ul>
	 * <li>value: the current input value associated with this attribute.</li>
	 * <li>messages: an array that may be appended with new error messages for
	 * the attribute.</li>
	 * <li>attribute: a data structure keeping all client-side options for the
	 * attribute</li>
	 * </ul>
	 * <b>Example</b>:
	 *
	 * If {@link clientValidate} is set to "clientValidate123",
	 * clientValidate123() is the name of
	 * the method that returns the client validation code and can look like:
	 * <pre>
	 * <?php
