...
class CRequiredValidator extends CValidator {
	 ...
	 *      If this is null, the validator will validate that the specified
	 *      attribute does not have null or empty value.
	 *      If this is set as a value that is not null, the validator will
	 *      validate that
	...
	/**
	 *
	 * @var boolean whether the value should be trimmed with php trim() function
	 *      when comparing strings.
	 *      When set to false, the attribute value is not considered empty when
	 *      it contains spaces.
