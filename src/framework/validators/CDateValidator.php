 ...
 *
 * By setting the {@link format} property, one can specify what format the date
 * value
 * must be in. If the given date value doesn't follow the format, the attribute
...
class CDateValidator extends CValidator {
	 ...
	 *      formats.
	 *      Defaults to 'MM/dd/yyyy'. Please see {@link CDateTimeParser} for
	 *      details
	 ...
	 *      When this property is not null and the validation is successful, the
	 *      named attribute will
	...
	protected function validateAttribute($object, $attribute) {
		...
		// reason of array checking is explained here:
