 ...
 * {@link itemAt}, {@link add}, {@link insertAt}, {@link remove}, and {@link
 * removeAt}.
 ...
 * operation (e.g. performing type check), override {@link insertAt()}, and
 * {@link removeAt()}.
 *
 * @property boolean $readOnly Whether this list is read-only or not. Defaults
 *           to false.
 * @property Iterator $iterator An iterator for traversing the items in the
 *           list.
...
class CList extends CComponent implements IteratorAggregate, ArrayAccess, Countable {
	 ...
	 * @param mixed $item
	 *        	new item
	 * @throws CException If the index specified exceeds the bound or the list
	 *         is read-only
	 */
	 ...
	 * @param mixed $item
	 *        	the item
	 * @return integer the index of the item in the list (0 based), -1 if not
	 *         found.
	 */
