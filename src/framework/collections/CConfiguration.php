...
class CConfiguration extends CMap {
	 ...
	 * 
	 * @param mixed $data
	 *        	if string, it represents a config file (a PHP script returning
	 ...
	 * configuration.
	 *
	 * A config file must be a PHP script returning a configuration array (like
	 * the following)
	 * <pre>
	 * return array
	 * (
	 ...
	 *        	configuration file path (if using relative path, be aware of
	 ...
	 * The string is a valid PHP expression representing the configuration data
	 * as an array.
	 * 
