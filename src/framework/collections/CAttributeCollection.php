...
class CAttributeCollection extends CMap {
	...
	/**
	 * Returns a property value or an event handler list by property or event
	 * name.
	 ...
	 * This overrides the parent implementation by converting the key to lower
	 * case first if {@link caseSensitive} is false.
	 * 
	 * @param mixed $key
	 *        	the key
