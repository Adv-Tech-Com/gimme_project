 ...
 *
 * CAuthManager extends {@link CApplicationComponent} and implements some
 * methods
 ...
 * {@link CAuthItem authorization items}. Items on higer level inherit the
 * permissions
 ...
 * to do something if the corresponding authorization item is inherited by one
 * of his roles.
 *
 ...
 * provides APIs to accomplish this task. Developers may need to develop some
 * GUI
 * so that it is more intuitive to end-users. Second, developers call {@link
...
abstract class CAuthManager extends CApplicationComponent implements IAuthManager {
	 ...
	 *      For performance reason, you should minimize the number of such
	 *      roles.
	 *      A typical usage of such roles is to define an 'authenticated' role
	 *      and associate
	 *      it with a biz rule which checks if the current user is
	 *      authenticated.
	 *      And then declare 'authenticated' in this property so that it can be
	 *      applied to
	 ...
	 * 
	 * @param mixed $userId
	 *        	the user ID. If not null, only the roles directly assigned to
	 *        	the user
	 ...
	 * 
	 * @param mixed $userId
	 *        	the user ID. If not null, only the tasks directly assigned to
	 *        	the user
	 ...
	 * 
	 * @param mixed $userId
	 *        	the user ID. If not null, only the operations directly
	 ...
	 * @param mixed $data
	 *        	additional data associated with the authorization item or
	 *        	assignment.
	 ...
	 *        	child item type
	 * @throws CException if the item cannot be added as a child due to its
	 *         incompatible type.
	 */
