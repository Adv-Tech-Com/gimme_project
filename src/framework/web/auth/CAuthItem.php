 ...
 * A user may be assigned one or several authorization items (called {@link
 * CAuthAssignment assignments}.
...
class CAuthItem extends CComponent {
	 ...
	 * @param integer $type
	 *        	authorization item type. This can be 0 (operation), 1 (task)
	 *        	or 2 (role).
	 ...
	 * this item.
	 * This method is expected to be internally used by the actual
	 * implementations
	 ...
	 * @return boolean whether the specified item is within the hierarchy
	 *         starting from this item.
	 */
	...
	/**
	 *
	 * @return integer the authorization item type. This could be 0 (operation),
	 *         1 (task) or 2 (role).
	 */
	...
	/**
	 * Returns a value indicating whether this item has been assigned to the
	 * user.
	 * 
	 * @param mixed $userId
	 *        	the user ID (see {@link IWebUser::getId})
