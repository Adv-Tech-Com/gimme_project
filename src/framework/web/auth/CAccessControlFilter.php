 ...
 * permissions.
 * When the user is not denied by one of the security rules or allowed by a rule
 * explicitly,
 ...
 *
 * To specify the access rules, set the {@link setRules rules} property, which
 * should
 * be an array of the rules. Each rule is specified as an array of the following
 * structure:
 * <pre>
 * array(
 * 'allow', // or 'deny'
 ...
 *
 * // optional, list of controller IDs (case insensitive) that this rule applies
 * to
 ...
 * 'ips'=>array('127.0.0.1'),
 *
 * // optional, list of request types (case insensitive) that this rule applies
 * to
 ...
 * // access is denied, instead of showing the customized error message. It can
 * also be
 * // a valid PHP callback, including class method name (array(ClassName/Object,
 * MethodName)),
...
class CAccessControlFilter extends CFilter {
	 ...
	 *      This property can be overridden by individual access rule via {@link
	 *      CAccessRule::message}.
	 *      If this property is not set, a default error message will be
	 *      displayed.
	 * @since 1.1.1
	 */
	public $message;
	 ...
	 * This method will check {@link message} and {@link CAccessRule::message}
	 * to see
...
/**
 * CAccessRule represents an access rule that is managed by {@link
...
class CAccessRule extends CComponent {
	...
	/**
	 *
	 * @var array list of action IDs that this rule applies to. The comparison
	 *      is case-insensitive.
	...
	/**
	 *
	 * @var array list of controller IDs that this rule applies to. The
	 *      comparison is case-insensitive.
	 */
	public $controllers;
	/**
	 *
	 * @var array list of user names that this rule applies to. The comparison
	 *      is case-insensitive.
	...
	/**
	 *
	 * @var array list of roles this rule applies to. For each role, the current
	 *      user's
	 *      {@link CWebUser::checkAccess} method will be invoked. If one of the
	 *      invocations
	 *      returns true, the rule will be applied.
	 *      Note, you should mainly use roles in an "allow" rule because by
	 *      definition,
	...
	/**
	 *
	 * @var array list of request types (e.g. GET, POST) that this rule applies
	 *      to.
	 */
	public $verbs;
	/**
	 *
	 * @var string a PHP expression whose value indicates whether this rule
	 *      should be applied.
	 *      In this expression, you can use <code>$user</code> which refers to
	 *      <code>Yii::app()->user</code>.
	 *      The expression can also be a valid PHP callback,
	 *      including class method name (array(ClassName/Object, MethodName)),
	 *      or anonymous function (PHP 5.3.0+). The function/method signature
	...
	/**
	 *
	 * @var string the error message to be displayed when authorization is
	 *      denied by this rule.
	 ...
	 *      access is denied. It replaces the behavior that shows an error
	 *      message.
	 *      It can be a valid PHP callback including class method name
	 *      (array(ClassName/Object, MethodName)),
	 *      or anonymous function (PHP 5.3.0+). For more information, on
	 ...
	 * @return integer 1 if the user is allowed, -1 if the user is denied, 0 if
	 *         the rule does not apply to the user
	 */
	 ...
	 * @param IWebUser $user
	 *        	the user
	 * @return boolean the expression value. True if the expression is not
	 *         specified.
	 */
