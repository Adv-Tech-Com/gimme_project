...
class CPhpAuthManager extends CAuthManager {
	/**
	 *
	 * @var string the path of the PHP script that contains the authorization
	 *      data.
	 *      If not set, it will be using 'protected/data/auth.php' as the data
	 *      file.
	 *      Make sure this file is writable by the Web server process if the
	 *      authorization
	 *      needs to be changed.
	 * @see loadFromFile
	 * @see saveToFile
	 ...
	 * This method overrides parent implementation by loading the authorization
	 * data
	 * from PHP script.
	 */
	 ...
	 * @param mixed $userId
	 *        	the user ID. This can be either an integer or a string
	 *        	representing
	...
	public function saveAuthItem($item, $oldName = null) {
		if ($oldName !== null && ($newName = $item->getName ()) !== $oldName) 		// name
		                                                              // changed
		{
	 ...
	 *        	parent item name
	 * @param string $childName
	 *        	the name of the child item that is to be added to the
	 *        	hierarchy
