 ...
 * database schema
 * should be as described in "framework/web/auth/*.sql". You may change the
 * names of
 * the three tables used to store the authorization data by setting {@link
 * itemTable},
...
class CDbAuthManager extends CAuthManager {
	 ...
	 *      Defaults to 'db'.
	 *      The database must have the tables as declared in
	 ...
	 * This method overrides the parent implementation by establishing the
	 * database connection.
	 */
	 ...
	 * @param mixed $userId
	 *        	the user ID. This should can be either an integer and a string
	 *        	representing
