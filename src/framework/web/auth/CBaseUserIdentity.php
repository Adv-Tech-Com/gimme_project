 ...
 * and {@link IUserIdentity::getId} that are required by the {@link
 * IUserIdentity}
 * interface.
 *
 * @property mixed $id A value that uniquely represents the identity (e.g.
 *           primary key value).
 ...
 * @property array $persistentStates The identity states that should be
 *           persisted.
...
abstract class CBaseUserIdentity extends CComponent implements IUserIdentity {
	...
	/**
	 *
	 * @var integer the authentication error code. If there is an error, the
	 *      error code will be non-zero.
	 *      Defaults to 100, meaning unknown identity. Calling {@link
	 *      authenticate} will change this value.
	 */
	 ...
	 *        	the default value to be returned if the named state does not
	 *        	exist
