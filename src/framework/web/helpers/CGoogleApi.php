...
/**
 * CGoogleApi provides helper methods to easily access the {@link
 * https://developers.google.com/loader/ Google API loader}.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CGoogleApi {
	/**
	 *
	 * @var string Protocol relative url to the Google API loader which allows
	 *      easy access
	 ...
	 *        	the module version
	 * @param array $options
	 *        	additional js options that are to be passed to the load()
	 *        	function.
	 * @return string the js code for loading the module. You can use {@link
	 *         CHtml::script()}
