...
class CJavaScript {
	 ...
	 * </pre>
	 *
	 * For highly complex data structures use {@link jsonEncode} and {@link
	 * jsonDecode}
	 ...
	 *        	wrapping code with {@link CJavaScriptExpression} JavaScript
	 *        	expression
	...
	public static function encode($value, $safe = false) {
		...
		elseif (is_float ( $value )) {
			...
			elseif ($value === INF)
				...
				return str_replace ( ',', '.', ( float ) $value ); // locale-independent
				                                           // representation
