...
/**
 * CBaseController is the base class for {@link CController} and {@link
 * CWidget}.
 *
 ...
 * <ul>
 * <li>{@link CClipWidget Clips} : a clip is a piece of captured output that can
 * be inserted elsewhere.</li>
 * <li>{@link CWidget Widgets} : a widget is a self-contained sub-controller
 * with its own view and model.</li>
 * <li>{@link COutputCache Fragment cache} : fragment cache selectively caches a
 * portion of the output.</li>
 * </ul>
 *
...
abstract class CBaseController extends CComponent {
	 ...
	 *        	view name
	 * @return string the file path for the named view. False if the view cannot
	 *         be found.
	 */
	 ...
	 * Starting from version 1.1, if a {@link CWidgetFactory widget factory} is
	 * enabled,
	 ...
	 * 
	 * @param string $className
	 *        	the widget class name or class in dot syntax (e.g.
	 *        	application.widgets.MyWidget)
	 * @param array $properties
	 *        	list of initial property values for the widget (Property Name
	 *        	=> Property Value)
	 * @param boolean $captureOutput
	 *        	whether to capture the output of the widget. If true, the
	 *        	method will capture
	 *        	and return the output generated by the widget. If false, the
	 *        	output will be directly sent for display
	 *        	and the widget object will be returned. This parameter is
	 *        	available since version 1.1.2.
	 * @return mixed the widget instance when $captureOutput is false, or the
	 *         widget output when $captureOutput is true.
	 */
	 ...
	 * 
	 * @param string $id
	 *        	optional tag identifying the method call for debugging
	 *        	purpose.
	 ...
	 * @return boolean whether we need to generate content for caching. False if
	 ...
	 * 
	 * @param mixed $view
	 *        	the name of the view that will be used to decorate the
	 *        	content. The actual view script
	 *        	is resolved via {@link getViewFile}. If this parameter is null
	 *        	(default),
	 *        	the default layout will be used as the decorative view.
	 *        	Note that if the current controller does not belong to
	 *        	any module, the default layout refers to the application's
	 *        	{@link CWebApplication::layout default layout};
	 *        	If the controller belongs to a module, the default layout
	 *        	refers to the module's
	 *        	{@link CWebModule::layout default layout}.
	 * @param array $data
	 *        	the variables (name=>value) to be extracted and made available
	 *        	in the decorative view.
	 * @see endContent
