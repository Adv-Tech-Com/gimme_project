 ...
 *           classes. Defaults to 'moduleDir/controllers'
...
class CWebModule extends CModule {
	/**
	 *
	 * @var string the ID of the default controller for this module. Defaults to
	 *      'default'.
	 */
	public $defaultController = 'default';
	/**
	 *
	 * @var mixed the layout that is shared by the controllers inside this
	 *      module.
	 *      If a controller has explicitly declared its own {@link
	 *      CController::layout layout},
	 *      this property will be ignored.
	 *      If this is null (default), the application's layout or the parent
	 *      module's layout (if available)
	 ...
	 *      Pleaser refer to {@link CWebApplication::controllerMap} for more
	 *      details.
	 */
	 ...
	 *         Defaults to 'moduleDir/controllers' where
	 *         moduleDir is the directory containing the module class.
	 */
	 ...
	 * and all its filters
	 * are executed. If you override this method, make sure you call the parent
