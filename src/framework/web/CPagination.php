 ...
 * @property integer $currentPage The zero-based index of the current page.
 *           Defaults to 0.
 * @property integer $offset The offset of the data. This may be used to set the
 *           OFFSET value for a SQL statement for fetching the current page of
 *           data.
 * @property integer $limit The limit of the data. This may be used to set the
 *           LIMIT value for a SQL statement for fetching the current page of
 *           data.
...
class CPagination extends CComponent {
	...
	/**
	 *
	 * @var string name of the GET variable storing the current page index.
	 *      Defaults to 'page'.
	 */
	public $pageVar = 'page';
	/**
	 *
	 * @var string the route (controller ID and action ID) for displaying the
	 *      paged contents.
	...
	/**
	 *
	 * @var array of parameters (name=>value) that should be used instead of GET
	 *      when generating pagination URLs.
	...
	/**
	 *
	 * @var boolean whether to ensure {@link currentPage} is returning a valid
	 *      page number.
	 *      When this property is true, the value returned by {@link
	 *      currentPage} will always be between
	 *      0 and ({@link pageCount}-1). Because {@link pageCount} relies on the
	 *      correct value of {@link itemCount},
	 *      it means you must have knowledge about the total number of data
	 *      items when you want to access {@link currentPage}.
	 *      This is fine for SQL-based queries, but may not be feasible for
	 *      other kinds of queries (e.g. MongoDB).
	 *      In those cases, you may set this property to be false to skip the
	 *      validation (you may need to validate yourself then).
	 *      Defaults to true.
	 * @since 1.1.4
	 */
	 ...
	 *        	whether to recalculate the current page based on the page size
	 *        	and item count.
	 ...
	 * @param integer $page
	 *        	the page that the URL should point to. This is a zero-based
	 *        	index.
