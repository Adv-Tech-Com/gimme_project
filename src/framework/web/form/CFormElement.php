 ...
 *
 * @property boolean $visible Whether this element is visible and should be
 *           rendered.
 * @property mixed $parent The direct parent of this element. This could be
 *           either a {@link CForm} object or a {@link CBaseController} object
...
abstract class CFormElement extends CComponent {
	/**
	 *
	 * @var array list of attributes (name=>value) for the HTML element
	 ...
	 *        	It can also be a string representing the file name of the PHP
	 *        	script
	 ...
	 * rendered.
	 * This method will call {@link evaluateVisible} to determine the visibility
	 * of this element.
	 * 
	...
	/**
	 *
	 * @return mixed the direct parent of this element. This could be either a
	 *         {@link CForm} object or a {@link CBaseController} object
	 *         (a controller or a widget).
	 */
	 ...
	 * Child classes should override this method to implement the actual
	 * algorithm
