 ...
 * {@link type} property:
 * <ul>
 * <li>htmlButton: a normal button generated using {@link
 * CHtml::htmlButton}</li>
 * <li>htmlReset a reset button generated using {@link CHtml::htmlButton}</li>
 * <li>htmlSubmit: a submit button generated using {@link
 * CHtml::htmlButton}</li>
 ...
 * class. In this case,
 * the button is generated using a widget of the specified class. Note, the
 * widget must
...
class CFormButtonElement extends CFormElement {
	...
	/**
	 *
	 * @var string the type of this button. This can be a class name, a path
	 *      alias of a class name,
	 *      or a button type alias (submit, button, image, reset, link,
	...
	/**
	 *
	 * @var string the label of this button. This property is ignored when a
	 *      widget is used to generate the button.
	 */
	public $label;
	private $_on;
	 ...
	 * If the value is empty, it means the button is visible under all
	 * scenarios.
	 * Otherwise, only when the model is in the scenario whose name can be found
	 * in
	 * this value, will the button be visible. See {@link CModel::scenario} for
	 * more
