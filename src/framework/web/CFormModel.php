...
class CFormModel extends CModel {
	 ...
	 *        	See {@link CModel::scenario} on how scenario is used by
	 *        	models.
	 * @see getScenario
	 */
	 ...
	 * This method is invoked in the constructor right after {@link scenario} is
	 * set.
	 * You may override this method to provide code that is needed to initialize
	 * the model (e.g. setting
	 ...
	 * 
	 * @return array list of attribute names. Defaults to all public properties
	 *         of the class.
	 */
