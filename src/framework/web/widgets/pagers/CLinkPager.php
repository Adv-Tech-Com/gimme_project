...
class CLinkPager extends CBasePager {
	...
	/**
	 *
	 * @var string the CSS class for the previous page button. Defaults to
	 *      'previous'.
	 * @since 1.1.11
	 */
	...
	/**
	 *
	 * @var string the CSS class for the internal page buttons. Defaults to
	 *      'page'.
	 * @since 1.1.11
	 */
	...
	/**
	 *
	 * @var string the CSS class for the hidden page buttons. Defaults to
	 *      'hidden'.
	 * @since 1.1.11
	 */
	...
	/**
	 *
	 * @var string the CSS class for the selected page buttons. Defaults to
	 *      'selected'.
	 * @since 1.1.11
	 */
	...
	/**
	 *
	 * @var string the text label for the previous page button. Defaults to
	 *      '&lt; Previous'.
	 */
	public $prevPageLabel;
	/**
	 *
	 * @var string the text label for the first page button. Defaults to
	 *      '&lt;&lt; First'.
	 */
	...
	protected function createPageButtons() {
		...
		$currentPage = $this->getCurrentPage ( false ); // currentPage is calculated in
		                                           // getPageRange()
		$buttons = array ();
