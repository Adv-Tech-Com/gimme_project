 ...
 * <ol>
 * <li>Override {@link CController::actions()} and register an action of class
 * CCaptchaAction with ID 'captcha'.</li>
...
class CCaptchaAction extends CAction {
	/**
	 * The name of the GET parameter indicating whether the CAPTCHA image should
	 * be regenerated.
	 */
	...
	/**
	 *
	 * @var integer how many times should the same CAPTCHA be displayed.
	 *      Defaults to 3.
	...
	/**
	 *
	 * @var integer the font color. For example, 0x55FF00. Defaults to 0x2040A0
	 *      (blue color).
	 */
	...
	/**
	 *
	 * @var integer the minimum length for randomly generated word. Defaults to
	 *      6.
	 */
	public $minLength = 6;
	/**
	 *
	 * @var integer the maximum length for randomly generated word. Defaults to
	 *      7.
	 */
	public $maxLength = 7;
	/**
	 *
	 * @var integer the offset between characters. Defaults to -2. You can
	...
	/**
	 *
	 * @var string the TrueType font file. Defaults to SpicyRice.ttf which is
	 *      provided with the Yii release.
	 *      Note that non-free Duality.ttf has been changed to open/free
	 *      SpicyRice.ttf since 1.1.14.
	 */
	public $fontFile;
	/**
	 *
	 ...
	 *      This is mainly used in automated tests where we want to be able to
	 *      reproduce
	 *      the same verification code each time we run the tests.
	 *      Defaults to null, meaning the verification code will be randomly
	 *      generated.
	 * @since 1.1.4
	 */
	...
	/**
	 *
	 * @var string the graphic extension that will be used to draw CAPTCHA
	 *      image. Possible values
	 *      are 'gd', 'imagick' and null. Null value means that fallback mode
	 *      will be used: ImageMagick
	 ...
	 */
	public function run() {
		if (isset ( $_GET [self::REFRESH_GET_VAR] )) 		// AJAX request for regenerating
		                                        // code
		{
			...
			echo CJSON::encode ( array (
					...
					// we add a random 'v' parameter so that FireFox can refresh
					// the image
	...
	/**
	 * Renders the CAPTCHA image based on the code using library specified in
	 * the {@link $backend} property.
	 * 
	 * @param string $code
