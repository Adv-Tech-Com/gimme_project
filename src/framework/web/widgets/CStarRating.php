 ...
 * input.
 *
 * CStarRating is based on {@link http://www.fyneworks.com/jquery/star-rating/
 * jQuery Star Rating Plugin}.
 * It displays a list of stars indicating the rating values. Users can toggle
 * these stars
 * to indicate their rating input. On the server side, when the rating input is
 * submitted,
...
class CStarRating extends CInputWidget {
	...
	/**
	 *
	 * @var mixed the minimum rating allowed. This can be either an integer or a
	 *      float value. Defaults to 1.
	 */
	public $minRating = 1;
	/**
	 *
	 * @var mixed the maximum rating allowed. This can be either an integer or a
	 *      float value. Defaults to 10.
	 */
	public $maxRating = 10;
	/**
	 *
	 * @var mixed the step size of rating. This is the minimum difference
	 *      between two rating values. Defaults to 1.
	 */
	...
	/**
	 *
	 * @var array the titles associated with the rating options. The keys are
	 *      ratings and the values are the corresponding titles.
	 *      Defaults to null, meaning using the rating value as the title.
	 */
	public $titles;
	/**
	 *
	 * @var string the hint text for the reset button. Defaults to null, meaning
	 *      using the system-defined text (which is 'Cancel Rating').
	 */
	public $resetText;
	/**
	 *
	 * @var string the value taken when the rating is cleared. Defaults to null,
	 *      meaning using the system-defined value (which is '').
	 */
	public $resetValue;
	/**
	 *
	 * @var boolean whether the rating value can be empty (not set). Defaults to
	 *      true.
	 *      When this is true, a reset button will be displayed in front of
	 *      stars.
	 */
	public $allowEmpty;
	/**
	 *
	 * @var integer the width of star image. Defaults to null, meaning using the
	 *      system-defined value (which is 16).
	 */
	public $starWidth;
	/**
	 *
	 * @var boolean whether the rating value is read-only or not. Defaults to
	 *      false.
