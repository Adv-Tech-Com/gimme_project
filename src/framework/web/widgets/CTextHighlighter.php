 ...
 *
 * The language of the syntax to be applied is specified via {@link language}
 * property.
...
class CTextHighlighter extends COutputProcessor {
	 ...
	 *      Valid values are those file names (without suffix) that are
	 *      contained
	 *      in 'vendors/TextHighlighter/Text/Highlighter'. Currently, the
	 *      following
	...
	/**
	 *
	 * @var boolean whether to show line numbers in the highlighted result.
	 *      Defaults to false.
	 * @see lineNumberStyle
	 */
	...
	/**
	 *
	 * @var string the style of line number display. It can be either 'list' or
	 ...
	 * This method highlights the output according to the syntax of the
