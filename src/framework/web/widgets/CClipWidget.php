...
class CClipWidget extends CWidget {
	/**
	 *
	 * @var boolean whether to render the clip content in place. Defaults to
	 *      false,
	 ...
	 * This method stops output buffering and saves the rendering result as a
	 * named clip in the controller.
	 */
	public function run() {
		$clip = ob_get_clean ();
		if ($this->renderClip)
