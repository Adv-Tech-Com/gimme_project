...
class CMaskedTextField extends CInputWidget {
	/**
	 *
	 * @var string the input mask (e.g. '99/99/9999' for date input). The
	 ...
	 *      <li>?: anything listed after '?' within the mask is considered
	 *      optional user input.</li>
	 *      </ul>
	 *      Additional characters can be defined by specifying the {@link
	 *      charMap} property.
	 */
	public $mask;
	/**
	 *
	 * @var array the mapping between mask characters and the corresponding
	 *      patterns.
	 *      For example, array('~'=>'[+-]') specifies that the '~' character
	 *      expects '+' or '-' input.
	 *      Defaults to null, meaning using the map as described in {@link
	 *      mask}.
	 */
	public $charMap;
	/**
	 *
	 * @var string the character prompting for user input. Defaults to
	 *      underscore '_'.
	 */
	public $placeholder;
	/**
	 *
	 * @var string a JavaScript function callback that will be invoked when user
	 *      finishes the input.
	 */
	public $completed;
