 ...
 * fragment
 * and passes it to its {@link onProcessOutput} event handlers for further
 * processing.
 *
 * The event handler may process the output and store it back to the {@link
 * COutputEvent::output}
 * property. By setting the {@link CEvent::handled handled} property of the
 * event parameter
 * to true, the output will not be echoed anymore. Otherwise (by default), the
 * output will be echoed.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class COutputProcessor extends CFilterWidget {
	 ...
	 * If the event is not handled by any event handler, the output will be
	 * echoed.
	 *
	 * @param string $output
