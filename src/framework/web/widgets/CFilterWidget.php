 ...
 * <ul>
 * <li>{@link CWidget::init()} : called when this is object is used as a widget
 * and needs initialization.</li>
 * <li>{@link CWidget::run()} : called when this is object is used as a
 * widget.</li>
 * <li>{@link filter()} : the filtering method called when this object is used
 * as an action filter.</li>
 * </ul>
 *
 * CFilterWidget provides all properties and methods of {@link CWidget} and
 * {@link CFilter}.
 *
...
class CFilterWidget extends CWidget implements IFilter {
	/**
	 *
	 * @var boolean whether to stop the action execution when this widget is
	 *      used as a filter.
	 *      This property should be changed only in {@link CWidget::init}
	 *      method.
