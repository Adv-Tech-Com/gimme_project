 ...
 * (without the .swf suffix), and set {@link baseUrl} to be URL (without the
 * ending slash)
...
class CFlexWidget extends CWidget {
	...
	/**
	 *
	 * @var string background color of the application region. Defaults to
	 *      '#FFFFFF', meaning white.
	 */
	...
	/**
	 *
	 * @var boolean whether to allow running the Flash in full screen mode.
	 *      Defaults to false.
	 * @since 1.1.1
	 */
	...
	/**
	 *
	 * @var string the HTML content to be displayed if Flash player is not
	 *      installed.
	 */
