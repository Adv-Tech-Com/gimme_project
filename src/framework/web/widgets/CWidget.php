 ...
 *
 * Compared with {@link CController controller}, a widget has neither actions
 * nor filters.
 *
 * Usage is described at {@link CBaseController} and {@link
 * CBaseController::widget}.
 *
 * @property CBaseController $owner Owner/creator of this widget. It could be
 *           either a widget or a controller.
...
class CWidget extends CBaseController {
	 ...
	 *      When a widget is declared an action provider in {@link
	 *      CController::actions},
	 *      a prefix can be specified to differentiate its action IDs from
	 *      others.
	...
	/**
	 *
	 * @var mixed the name of the skin to be used by this widget. Defaults to
	 *      'default'.
	...
	/**
	 *
	 * @var CBaseController owner/creator of this widget. It could be either a
	 *      widget or a controller.
	 */
	private $_owner;
	 ...
	 * this method. The widget will then become an action provider, and the
	 * actions
	 ...
	 *        	owner/creator of this widget. It could be either a widget or a
	 *        	controller.
	 */
	 ...
	 * 
	 * @return CBaseController owner/creator of this widget. It could be either
	 ...
	 * The default implementation returns the 'views' subdirectory of the
	 * directory containing the widget class file.
	 * If $checkTheme is set true, the directory "ThemeID/views/ClassName" will
	 * be returned when it exists.
	 * 
	 * @param boolean $checkTheme
	 *        	whether to check if the theme contains a view path for the
	 *        	widget.
	 ...
	 * This method will look for the view under the widget's {@link getViewPath
	 * viewPath}.
	 * The view script file is named as "ViewName.php". A localized view file
	 * may be returned if internationalization is needed. See {@link
	 * CApplication::findLocalizedFile}
	 * for more details.
	 * The view name can also refer to a path alias if it contains dot
	 * characters.
	 * 
