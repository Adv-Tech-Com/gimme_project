 ...
 * {@link CMarkdownParser}.
 * CMarkdown adds an additional option {@link purifyOutput} which can be set
 * true
...
class CMarkdown extends COutputProcessor {
	...
	/**
	 *
	 * @var boolean whether to use {@link CHtmlPurifier} to purify the generated
	 *      HTML code. Defaults to false.
	 */
	 ...
	 * This method calls {@link createMarkdownParser} to create the parser
	 * instance.
