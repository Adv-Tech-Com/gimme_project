 ...
 * http://www.fyneworks.com/jquery/multiple-file-upload/ jQuery Multi File
 * Upload plugin}.
 * The uploaded file information can be accessed via $_FILES[widget-name], which
 * gives an array of the uploaded
 * files. Note, you have to set the enclosing form's 'enctype' attribute to be
 * 'multipart/form-data'.
 *
 * Example:
 * <pre>
...
class CMultiFileUpload extends CInputWidget {
	 ...
	 *      Note, the server side still needs to check if the uploaded files
	 *      have allowed types.
	 */
	public $accept;
	/**
	 *
	 * @var integer the maximum number of files that can be uploaded. If -1, it
	 *      means no limits. Defaults to -1.
	 */
	public $max = - 1;
	/**
	 *
