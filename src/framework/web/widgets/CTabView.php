 ...
 * way.
 *
 * To specify contents and their tab structure, configure the {@link tabs}
 * property.
 * The {@link tabs} property takes an array with tab ID being mapped tab
 * definition.
 ...
 * </li>
 * <li>url: a URL that the user browser will be redirected to when clicking on
 * this tab.</li>
 * <li>data: array (name=>value), this will be passed to the view when 'view' is
 * specified.</li>
 * </ul>
 *
 ...
 * when the page is initially loaded, set {@link activeTab} to be the ID of the
 * desired tab.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class CTabView extends CWidget {
	...
	/**
	 *
	 * @var string the ID of the tab that should be activated when the page is
	 *      initially loaded.
	...
	/**
	 *
	 * @var array the data that will be passed to the partial view rendered by
	 *      each tab.
	 */
	public $viewData;
	/**
	 ...
	 *      <ul>
	 *      <li>title: the tab title. You need to make sure this is
	 *      HTML-encoded.</li>
	 *      <li>content: the content to be displayed in the tab.</li>
	 *      <li>view: the name of the view to be displayed in this tab.
	 *      The view will be rendered using the current controller's
	 *      {@link CController::renderPartial} method.
	 *      When both 'content' and 'view' are specified, 'content' will take
	 *      precedence.
	 *      </li>
	 *      <li>url: a URL that the user browser will be redirected to when
	 *      clicking on this tab.</li>
	 *      <li>data: array (name=>value), this will be passed to the view when
	 *      'view' is specified.
