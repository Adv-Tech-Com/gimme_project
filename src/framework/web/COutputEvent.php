 ...
 * handling.
 *
 * An event handler may retrieve the captured {@link output} for further
 * processing.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.web
...
class COutputEvent extends CEvent {
	/**
	 *
	 * @var string the output to be processed. The processed output should be
	 *      stored back to this property.
	 */
	public $output;
