 ...
 *
 * By default, the view being displayed is specified via the <code>view</code>
 * GET parameter.
 * The name of the GET parameter can be customized via {@link viewParam}.
 * If the user doesn't provide the GET parameter, the default view specified by
 * {@link defaultView}
 * will be displayed.
 *
 * Users specify a view in the format of <code>path.to.view</code>, which
 * translates to the view name
 * <code>BasePath/path/to/view</code> where <code>BasePath</code> is given by
 * {@link basePath}.
 *
...
class CViewAction extends CAction {
	/**
	 *
	 * @var string the name of the GET parameter that contains the requested
	 *      view name. Defaults to 'view'.
	 */
	public $viewParam = 'view';
	/**
	 *
	 * @var string the name of the default view when {@link viewParam} GET
	 *      parameter is not provided by user. Defaults to 'index'.
	 *      This should be in the format of 'path.to.view', similar to that
	 *      given in
	 *      the GET parameter.
	 * @see basePath
	 */
	...
	/**
	 *
	 * @var string the name of the view to be rendered. This property will be
	 *      set
	 ...
	 *      For example, if a user requests for <code>tutorial.chap1</code>, the
	 *      corresponding view name will
	 *      be <code>pages/tutorial/chap1</code>, assuming the base path is
	 *      <code>pages</code>.
	 *      The actual view file is determined by {@link
	 ...
	 *      This will be assigned to {@link CController::layout} before the view
	 *      is rendered.
	...
	/**
	 *
	 * @var boolean whether the view should be rendered as PHP script or static
	 ...
	 * If the user doesn't specify any view, the {@link defaultView} will be
	 * returned.
	 * 
