 ...
 * under the application runtime directory or together with the source view
 * file.
 *
...
abstract class CViewRenderer extends CApplicationComponent implements IViewRenderer {
	 ...
	 *      runtime directory. Defaults to true. If false, the parsing results
	 *      will
	 *      be saved as files under the same directory as the source view files
	 *      and the
	 ...
	 *      generated during parsing. Defaults to 0755 (owner rwx, group rx and
	 *      others rx).
	 */
