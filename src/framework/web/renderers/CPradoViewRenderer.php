...
class CPradoViewRenderer extends CViewRenderer {
	...
	protected function generateViewFile($sourceFile, $viewFile) {
		static $regexRules = array (
				...
				'<\/?(com|cache|clip):([\w\.]+)\s*((?:\s*\w+\s*=\s*\'.*?(?<!\\\\)\'|\s*\w+\s*=\s*".*?(?<!\\\\)"|\s*\w+\s*=\s*\{.*?\})*)\s*\/?>', // component
				                                                                                                                                 // tags
				'<!---.*?--->'  // template comments
		);
	...
	/*
	 * @param string $type type @param string $attributes attributes @param
	...
	/*
	 * @param string $type type @param string $offset offset
	 */
	...
	/*
	 * @param string $id id @param string $attributes attributes @param string
	 * $offset offset
	 */
	...
	/*
	 * @param string $id id @param string $offset offset
	 */
	...
	/*
	 * @param string $expression expression @param string $offset offset
	 */
	...
	/*
	 * @param string $statement statement @param string $offset offset
	 */
	...
	/*
	 * @param string $code code @param string $offset offset
	 */
