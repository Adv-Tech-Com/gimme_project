...
class CSqlDataProvider extends CDataProvider {
	...
	/**
	 *
	 * @var string CDbCommand SQL statement to be used for fetching data rows.
	 *      Since version 1.1.13 this can also be an instance of {@link
	 *      CDbCommand}.
	 */
	public $sql;
	/**
	 ...
	 *        	the SQL statement to be used for fetching data rows. Since
	 *        	version 1.1.13 this can also be an instance of {@link
	 *        	CDbCommand}.
	 * @param array $config
	 ...
	 * You may override this method to return accurate total number of data
	 * items.
	 * 
