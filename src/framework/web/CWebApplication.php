 ...
 * <ul>
 * <li>{@link urlManager}: provides URL parsing and constructing
 * functionality;</li>
 ...
 * parameters.
 * CWebApplication creates the requested controller instance and let it to
 * handle
 ...
 *
 * Controller class files must reside under the directory {@link
 * getControllerPath controllerPath}
 * (defaults to 'protected/controllers'). The file name and the class name must
 * be
 * the same as the controller ID with the first letter in upper case and
 * appended with 'Controller'.
 * For example, the controller 'article' is defined by the class
 * 'ArticleController'
 ...
 * @property CTheme $theme The theme used currently. Null if no theme is being
 *           used.
 ...
 *           classes. Defaults to 'protected/controllers'.
 ...
 *           Defaults to 'protected/views/system'.
...
class CWebApplication extends CApplication {
	/**
	 *
	 * @return string the route of the default controller, action or module.
	 *         Defaults to 'site'.
	 */
	public $defaultController = 'site';
	/**
	 *
	 * @var mixed the application-wide layout. Defaults to 'main' (relative to
	 *      {@link getLayoutPath layoutPath}).
	 ...
	 *      Each name-value pair specifies the configuration for a single
	 *      controller.
	 ...
	 *      If the latter, the array must contain a 'class' element which
	 *      specifies
	 *      the controller's class name or {@link YiiBase::getPathOfAlias class
	 *      path alias}.
	 ...
	 *      </pre>
	 *     
	 *      Note, when processing an incoming request, the controller map will
	 *      first be
	 *      checked to see if the request can be handled by one of the
	 *      controllers in the map.
	 *      If not, a controller will be searched for under the {@link
	 *      getControllerPath default controller path}.
	 */
	public $controllerMap = array ();
	/**
	 *
	 * @var array the configuration specifying a controller which should handle
	 *      all user requests. This is mainly used when the application is in
	 *      maintenance mode
	 ...
	 * This method overrides the parent implementation by registering additional
	 * core components.
	 * 
	 * @see setComponents
	 */
	 ...
	 * 
	 * @param string $route
	 *        	the route of the current request. See {@link createController}
	 *        	for more details.
	 ...
	 * It may also contain additional GET variables. All these must be
	 * concatenated together with slashes.
	 *
	 * This method will attempt to create a controller in the following order:
	 * <ol>
	 * <li>If the first segment is found in {@link controllerMap}, the
	 * corresponding
	 ...
	 * the corresponding controller. For example, if the route is
	 * "admin/user/create",
	 * then the controller will be created using the class file
	 * "protected/controllers/admin/UserController.php".</li>
	 * </ol>
	 * 
	 * @param string $route
	 ...
	 *        	null, meaning the application
	 *        	instance is the owner.
	 * @return array the controller instance and the action ID. Null if the
	 *         controller class does not exist or the route is invalid.
	 */
	 ...
	 *         Defaults to 'protected/controllers'.
	 */
	...
	/**
	 *
	 * @return string the root directory of system view files. Defaults to
	 ...
	 * This method is invoked before the currently requested controller action
	 * and all its filters
	 * are executed. You may override this method with logic that needs to be
	 * done
	 ...
	 * This method is invoked after the currently requested controller action
	 * and all its filters
	 * are executed. You may override this method with logic that needs to be
	 * done
	 ...
	 * @param string $id
	 *        	module ID
	 * @return CWebModule the module that has the specified ID. Null if no
	 *         module is found.
	 */
	 ...
	 * This method overrides the parent implementation by preloading the
	 * 'request' component.
	 */
