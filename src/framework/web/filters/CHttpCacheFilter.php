...
class CHttpCacheFilter extends CFilter {
	/**
	 *
	 * @var string integer for the last modification date.
	 *      Must be either a string parsable by {@link http://php.net/strtotime
	 *      strtotime()}
	...
	/**
	 *
	 * @var string callback Expression for the last modification date.
	 ...
	 *      Can be anything that passes through {@link http://php.net/serialize
	 *      serialize()}.
	 */
	public $etagSeed;
	/**
	 *
	 * @var string callback for the ETag seed.
	...
	/**
	 *
	 * @var string Http cache control headers. Set this to an empty string in
	 *      order to keep this
	...
	/**
	 * Gets the last modified value from either {@link lastModifiedExpression}
	 * or {@link lastModified}
	 * and converts it into a unix timestamp if necessary
	 * 
	 * @throws CException
	 * @return integer boolean unix timestamp or false if neither lastModified
	 *         nor
	...
	/**
	 * Gets the ETag out of either {@link etagSeedExpression} or {@link
	 * etagSeed}
	 * 
	 * @return string boolean a quoted string serving as ETag or false if
	 *         neither etagSeed nor etagSeedExpression have been set
	 */
	...
	/**
	 * Checks if the last modified date supplied by the client is still up to
	 * date
	 * 
	 * @param integer $lastModified
	 *        	the last modified date
	 * @return boolean true if the last modified date sent by the client is
	 *         newer or equal to $lastModified
	 */
