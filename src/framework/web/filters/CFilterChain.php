...
class CFilterChain extends CList {
	...
	/**
	 *
	 * @var integer the index of the filter that is to be executed when calling
	 *      {@link run()}.
	 */
	 ...
	 *         is read-only, or the item is not an {@link IFilter} instance.
	 */
	 ...
	 * After this method is called, {@link filterIndex} will be automatically
	 * incremented by one.
