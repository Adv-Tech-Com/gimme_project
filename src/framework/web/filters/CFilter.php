 ...
 * It can modify the context that the action is to run or decorate the result
 * that the
 * action generates.
 *
 * Override {@link preFilter()} to specify the filtering logic that should be
 * applied
 * before the action, and {@link postFilter()} for filtering logic after the
 * action.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
