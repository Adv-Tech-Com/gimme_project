 ...
 * at the first page
 * of results and ending at the last page. It is usually only suited for use
 * with {@link CActiveDataProvider}.
 *
 * For example, the following code will iterate over all registered users
 * (active record class User) without
...
class CDataProviderIterator extends CComponent implements Iterator, Countable {
	 ...
	 *        	pageSize to use for iteration. This is the number of objects
