 ...
 *
 * The {@link rawData} property contains all data that may be sorted and/or
 * paginated.
 ...
 * Make sure to set the {@link keyField} property to the name of the field that
 * uniquely
 ...
 * </pre>
 *
 * Note: if you want to use the sorting feature, you must configure {@link sort}
 * property
...
class CArrayDataProvider extends CDataProvider {
	/**
	 *
	 * @var string the name of the key field. This is a field that uniquely
	 *      identifies a
	 *      data record. In database this would be the primary key.
	 *      Defaults to 'id'. If it's set to false, keys of {@link rawData}
	 *      array are used.
	 */
	public $keyField = 'id';
	/**
	 *
	 * @var array the data that is not paginated or sorted. When pagination is
	 *      enabled,
	...
	/**
	 *
	 * @var boolean controls how sorting works. True value means that case will
	 *      be
	 *      taken into account. False value will lead to the case insensitive
	 *      sort. Default
	 *      value is true.
	 * @since 1.1.13
	 */
	 ...
	 * 
	 * @param array $rawData
	 *        	the data that is not paginated or sorted. The array elements
	 *        	must use zero-based integer keys.
	 * @param array $config
	 ...
	 *        	the sorting directions (field name => whether it is descending
	 *        	sort)
	 */
	 ...
	 * @param string $order
	 *        	the "ORDER BY" clause.
	 * @return array the sorting directions (field name => whether it is
	 *         descending sort)
	 */
