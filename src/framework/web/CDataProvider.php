...
abstract class CDataProvider extends CComponent implements IDataProvider {
	 ...
	 * 
	 * @return string the unique ID that uniquely identifies the data provider
	 ...
	 * 
	 * @param string $value
	 *        	the unique ID that uniquely identifies the data provider among
	 *        	all data providers.
	 */
	 ...
	 *        	the pagination object class name. Parameter is available since
	 *        	version 1.1.13.
	 * @return CPagination false pagination object. If this is false, it means
	 ...
	 * 
	 * @param mixed $value
	 *        	the pagination to be used by this data provider. This could be
	 *        	a {@link CPagination} object
	 *        	or an array used to configure the pagination object. If this
	 *        	is false, it means the pagination should be disabled.
	 *        	
	 ...
	 * 
	 * @param string $className
	 *        	the sorting object class name. Parameter is available since
	 *        	version 1.1.13.
	 * @return CSort false sorting object. If this is false, it means the
	 *         sorting is disabled.
	 */
	 ...
	 * 
	 * @param mixed $value
	 *        	the sorting to be used by this data provider. This could be a
	 *        	{@link CSort} object
	 *        	or an array used to configure the sorting object. If this is
	 *        	false, it means the sorting should be disabled.
	 *        	
	 *        	You can configure this property same way as a component:
	 *        	<pre>
	 *        	array(
	 ...
	 * This method is provided in case when the total number cannot be
	 * determined by {@link calculateTotalItemCount}.
	 * 
	 * @param integer $value
