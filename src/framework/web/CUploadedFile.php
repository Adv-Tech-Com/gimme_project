 ...
 *           Note, this is a temporary file which will be automatically deleted
 *           by PHP
 *           after the current request is processed.
 * @property string $type The MIME-type of the uploaded file (such as
 *           "image/gif").
 *           Since this MIME type is not checked on the server side, do not take
 *           this value for granted.
 *           Instead, use {@link CFileHelper::getMimeType} to determine the
 *           exact MIME type.
 ...
 *           The extension name does not include the dot character. An empty
 *           string
...
class CUploadedFile extends CComponent {
	 ...
	 *        	the attribute name. For tabular file uploading, this can be in
	 *        	the format of "[$i]attributeName", where $i stands for an
	 *        	integer index.
	 * @return CUploadedFile the instance of the uploaded file.
	 *         Null is returned if no file is uploaded for the specified model
	 *         attribute.
	 ...
	 *         Empty array is returned if no available file was found for the
	 *         given attribute.
	 */
	 ...
	 * @return CUploadedFile[] the array of CUploadedFile objects. Empty array
	 *         is returned
	 *         if no adequate upload was found. Please note that this array will
	 *         contain
	 *         all files from all subarrays regardless how deeply nested they
	 *         are.
	 */
	 ...
	 * 
	 * @param string $key
	 *        	key for identifiing uploaded file: class name and subarray
	 *        	indexes
	 * @param mixed $names
	 ...
	 * Note: this method uses php's move_uploaded_file() method. As such, if the
	 * target file ($file)
	 ...
	 *         Note, this is a temporary file which will be automatically
	 *         deleted by PHP
	 *         after the current request is processed.
	 */
	 ...
	 *         Since this MIME type is not checked on the server side, do not
	 *         take this value for granted.
	 *         Instead, use {@link CFileHelper::getMimeType} to determine the
	 *         exact MIME type.
	 */
