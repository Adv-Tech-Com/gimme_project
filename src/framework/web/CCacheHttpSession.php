 ...
 * {@link ICache} interface.
 * The ID of the cache application component is specified via {@link cacheID},
 * which defaults to 'cache'.
 *
 * Beware, by definition cache storage are volatile, which means the data stored
 * on them
 * may be swapped out and get lost. Therefore, you must make sure the cache used
 * by this component
 * is NOT volatile. If you want to use {@link CDbCache} as storage medium, use
 * {@link CDbHttpSession}
 * is a better choice.
 *
...
class CCacheHttpSession extends CHttpSession {
	...
	/**
	 *
	 * @var string the ID of the cache application component. Defaults to
	 *      'cache' (the primary cache application component.)
	 */
	 ...
	 * This method overrides the parent implementation by checking if cache is
	 * available.
	 */
