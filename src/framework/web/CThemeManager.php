 ...
 * Web accessible, please make sure the view/layout files are protected from Web
 * access.
 *
 * @property array $themeNames List of available theme names.
 * @property string $basePath The base path for all themes. Defaults to
 *           "WebRootPath/themes".
 * @property string $baseUrl The base URL for all themes. Defaults to
 *           "/WebRoot/themes".
 *          
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.web
...
class CThemeManager extends CApplicationComponent {
	 ...
	 *      Defaults to {@link CTheme}. This can also be a class name in dot
	 *      syntax.
	 */
	...
	/**
	 *
	 * @return string the base path for all themes. Defaults to
	 *         "WebRootPath/themes".
	 */
	...
	/**
	 *
	 * @return string the base URL for all themes. Defaults to
	 *         "/WebRoot/themes".
	 */
