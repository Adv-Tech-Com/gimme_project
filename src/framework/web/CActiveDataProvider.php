 ...
 * of class {@link modelClass}. It uses the AR {@link CActiveRecord::findAll}
 * method
 * to retrieve the data from database. The {@link criteria} property can be used
 * to
 ...
 * @property CDbCriteria $countCriteria The count query criteria. This property
 *           is available
 *           since 1.1.14
 * @property CSort $sort The sorting object. If this is false, it means the
 *           sorting is disabled.
 *          
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @package system.web
...
class CActiveDataProvider extends CDataProvider {
	/**
	 *
	 * @var string the primary ActiveRecord class name. The {@link getData()}
	 *      method
	...
	/**
	 *
	 * @var CActiveRecord the AR finder instance (eg
	 *      <code>Post::model()</code>).
	 *      This property can be set by passing the finder instance as the first
	 *      parameter
	 *      to the constructor. For example,
	 *      <code>Post::model()->published()</code>.
	 * @since 1.1.3
	 */
	public $model;
	/**
	 ...
	 *      it means the primary key of the corresponding database table will be
	 *      used.
	 */
	public $keyAttribute;
	 ...
	 *        	(e.g. <code>Post::model()</code>,
	 *        	<code>Post::model()->published()</code>).
	 * @param array $config
	 *        	configuration (name=>value) to be applied as the initial
	 ...
	 *        	the query criteria. This can be either a CDbCriteria object or
	 *        	an array
	 ...
	 * 
	 * @param CDbCriteria|array $value
	 *        	the count query criteria. This can be either a CDbCriteria
	 *        	object
