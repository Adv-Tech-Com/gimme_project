 ...
 *
 * The main purpose of CExtController is to redefine the {@link viewPath}
 * property
...
class CExtController extends CController {
	 ...
	 * This method overrides the parent implementation by specifying the view
	 * path
	 * to be the "views" subdirectory under the directory containing the
	 * controller
	 * class file.
	 * 
