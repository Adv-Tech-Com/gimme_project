 ...
 *
 * @property string $methodName The currently requested method name. Empty if no
...
class CWebService extends CComponent {
	...
	/**
	 *
	 * @var string object web service provider class or object.
	...
	/**
	 *
	 * @var string the URL for the Web service. This is required by {@link
	 *      generateWsdl()} and {@link renderWsdl()}.
	 */
	public $serviceUrl;
	/**
	 *
	 * @var integer number of seconds that the generated WSDL can remain valid
	 *      in cache. Defaults to 0, meaning no caching.
	 */
	public $wsdlCacheDuration = 0;
	/**
	 *
	 * @var string the ID of the cache application component that is used to
	 *      cache the generated WSDL.
	 ...
	 *      This should be an array with WSDL types as keys and names of PHP
	 *      classes as values.
	...
	/**
	 *
	 * @var string SOAP version (e.g. '1.1' or '1.2'). Defaults to null, meaning
	 *      not set.
	 */
	public $soapVersion;
	/**
	...
	/**
	 *
	 * @var string array generator configuration. This property may be useful in
	 *      purpose of enhancing features
	 *      of the standard {@link CWsdlGenerator} class by extending it. For
	 *      example, some developers may need support
	 *      of the <code>xsd:xsd:base64Binary</code> elements. Another use case
	 *      is to change initial values
	 *      at instantiation of the default {@link CWsdlGenerator}. The value of
	 *      this property will be passed
	 *      to {@link Yii::createComponent} to create the generator object.
	 ...
	 *        	the URL for the Web service. This is required by {@link
	 *        	generateWsdl()} and {@link renderWsdl()}.
	 */
	...
	public function run() {
		...
		try {
			...
			{
				// only log for non-PHP-error case because application's error
				// handler already logs it
	...
	/**
	 *
	 * @return string the currently requested method name. Empty if no method is
	 *         being requested.
	 */
