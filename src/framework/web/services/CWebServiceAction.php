 ...
 * is used to differentiate these two aspects: the existence of the GET
 * parameter
...
class CWebServiceAction extends CAction {
	 ...
	 *      Defaults to null, meaning the current controller is used as the
	 *      service provider.
	 *      If the provider implements the interface {@link
	 *      IWebServiceProvider},
	 *      it will be able to intercept the remote method invocation and
	 *      perform
	 ...
	 *      In this case, a GET parameter named {@link serviceVar} will be used
	 *      to
	...
	/**
	 *
	 * @var string the name of the GET parameter that differentiates a WSDL
	 *      request
	 *      from a Web service request. If this GET parameter exists, the
	 *      request is considered
	 *      as a Web service request; otherwise, it is a WSDL request. Defaults
	 *      to 'ws'.
	 */
	public $serviceVar = 'ws';
	/**
	 *
	 * @var array a list of PHP classes that are declared as complex types in
	 *      WSDL.
	...
	/**
	 *
	 * @var array the initial property values for the {@link CWebService}
	 *      object.
	 *      The array keys are property names of {@link CWebService} and the
	 *      array values
	...
	/**
	 * Runs the action.
	 * If the GET parameter {@link serviceVar} exists, the action handle the
