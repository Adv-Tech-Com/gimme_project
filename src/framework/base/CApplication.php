 ...
 * uncaught exceptions. This application component is dynamically loaded when
 * needed.</li>
 * <li>{@link getSecurityManager securityManager}: provides security-related
 * services, such as hashing, encryption. This application component is
 * dynamically
 * loaded when needed.</li>
 * <li>{@link getStatePersister statePersister}: provides global state
 * persistence method. This application component is dynamically loaded when
 * needed.</li>
 * <li>{@link getCache cache}: provides caching feature. This application
 * component is
 * disabled by default.</li>
 * <li>{@link getMessages messages}: provides the message source for translating
 * application messages. This application component is dynamically loaded when
 * needed.</li>
 * <li>{@link getCoreMessages coreMessages}: provides the message source for
 * translating
 * Yii framework messages. This application component is dynamically loaded when
 * needed.</li>
 * <li>{@link getUrlManager urlManager}: provides URL construction as well as
 * parsing functionality.
 * This application component is dynamically loaded when needed.</li>
 * <li>{@link getRequest request}: represents the current HTTP request by
 * encapsulating
 * the $_SERVER variable and managing cookies sent from and sent to the user.
 * This application component is dynamically loaded when needed.</li>
 * <li>{@link getFormat format}: provides a set of commonly used data formatting
 * methods.
 * This application component is dynamically loaded when needed.</li>
 * </ul>
 *
 * CApplication will undergo the following lifecycles when processing a user
 * request:
 * <ol>
 ...
 * @property string $basePath The root directory of the application. Defaults to
 *           'protected'.
 * @property string $runtimePath The directory that stores runtime files.
 *           Defaults to 'protected/runtime'.
 * @property string $extensionPath The directory that contains all extensions.
 *           Defaults to the 'extensions' directory under 'protected'.
 * @property string $language The language that the user is using and the
 *           application should be targeted to.
 *           Defaults to the {@link sourceLanguage source language}.
 * @property string $timeZone The time zone used by this application.
 * @property CLocale $locale The locale instance.
 * @property string $localeDataPath The directory that contains the locale data.
 *           It defaults to 'framework/i18n/data'.
 * @property CNumberFormatter $numberFormatter The locale-dependent number
 *           formatter.
 ...
 * @property CErrorHandler $errorHandler The error handler application
 *           component.
 * @property CSecurityManager $securityManager The security manager application
 *           component.
 * @property CStatePersister $statePersister The state persister application
 *           component.
 * @property CCache $cache The cache application component. Null if the
 ...
 * @property CController $controller The currently active controller. Null is
 *           returned in this base class.
...
abstract class CApplication extends CModule {
	...
	/**
	 *
	 * @var string the charset currently used for the application. Defaults to
	 *      'UTF-8'.
	 */
	public $charset = 'UTF-8';
	/**
	 *
	 * @var string the language that the application is written in. This mainly
	 *      refers to
	 *      the language that the messages and view files are in. Defaults to
	 *      'en_us' (US English).
	 */
	 ...
	 *        	Please make sure you specify the {@link getBasePath basePath}
	 ...
	 * This method loads static application components. Derived classes usually
	 * overrides this
	 * method to do more application-specific tasks.
	 * Remember to call the parent implementation so that static application
	 ...
	 *        	exit status (value 0 means normal exit while other values mean
	 *        	abnormal exit).
	 * @param boolean $exit
	 *        	whether to exit the current request. This parameter has been
	 *        	available since version 1.1.5.
	 *        	It defaults to true, meaning the PHP's exit() function will be
	 ...
	 * 
	 * @return string the root directory of the application. Defaults to
	 *         'protected'.
	 */
	 ...
	 * 
	 * @return string the directory that stores runtime files. Defaults to
	 *         'protected/runtime'.
	 */
	 ...
	 * 
	 * @return string the directory that contains all extensions. Defaults to
	 *         the 'extensions' directory under 'protected'.
	 */
	 ...
	 * targeted to.
	 * 
	 * @return string the language that the user is using and the application
	 ...
	 *        	the language that the original file is in. If null, the
	 *        	application {@link sourceLanguage source language} is used.
	 * @param string $language
	 *        	the desired language that the file should be localized to. If
	 *        	null, the {@link getLanguage application language} will be
	 *        	used.
	 * @return string the matching localized file. The original file is returned
	 *         if no localized version is found
	 ...
	 *        	the locale ID (e.g. en_US). If null, the {@link getLanguage
	 *        	application language ID} will be used.
	 ...
	 * 
	 * @return string the directory that contains the locale data. It defaults
	 *         to 'framework/i18n/data'.
	 * @since 1.1.0
	 */
	 ...
	 * 
	 * @return CCache the cache application component. Null if the component is
	 *         not enabled.
	 */
	...
	/**
	 *
	 * @return CController the currently active controller. Null is returned in
	 *         this base class.
	 * @since 1.1.8
	 */
	 ...
	 *
	 * A global value is one that is persistent across users sessions and
	 * requests.
	 * 
	 * @param string $key
	 *        	the name of the value to be returned
	 * @param mixed $defaultValue
	 *        	the default value. If the named global value is not found,
	 ...
	 * @param mixed $defaultValue
	 *        	the default value. If the named global value is the same as
	 *        	this value, it will be cleared from the current storage.
	 * @see getGlobalState
	 */
