 ...
 * @property string $basePath The root directory of the module. Defaults to the
 *           directory containing the module class.
 * @property CAttributeCollection $params The list of user-defined parameters.
 * @property string $modulePath The directory that contains the application
 *           modules. Defaults to the 'modules' subdirectory of {@link
 *           basePath}.
 * @property CModule $parentModule The parent module. Null if this module does
 *           not have a parent.
 * @property array $modules The configuration of the currently installed modules
 *           (module ID => configuration).
 * @property array $components The application components (indexed by their
 *           IDs).
 * @property array $import List of aliases to be imported.
 * @property array $aliases List of aliases to be defined. The array keys are
 *           root aliases,
 *           while the array values are paths or aliases corresponding to the
 *           root aliases.
 *           For example,
 *           <pre>
 *           array(
...
abstract class CModule extends CComponent {
	/**
	 *
	 * @var array the IDs of the application components that should be
	 *      preloaded.
	 */
	 ...
	 *      The behaviors will be attached to the module when {@link init} is
	 *      called.
	 *      Please refer to {@link CModel::behaviors} on how to specify the
	 ...
	 * 
	 * @return string the root directory of the module. Defaults to the
	 *         directory containing the module class.
	 */
	 ...
	 *         Defaults to the 'modules' subdirectory of {@link basePath}.
	 */
	 ...
	 *        	list of aliases to be defined. The array keys are root
	 *        	aliases,
	 *        	while the array values are paths or aliases corresponding to
	 *        	the root aliases.
	 *        	For example,
	 *        	<pre>
	 *        	array(
	 ...
	 * 
	 * @return CModule the parent module. Null if this module does not have a
	 *         parent.
	 */
	 ...
	 * The module has to be declared in {@link modules}. A new instance will be
	 * created
	 * when calling this method with the given ID for the first time.
	 * 
	 * @param string $id
	 *        	application module ID (case-sensitive)
	 * @return CModule the module instance, null if the module is disabled or
	 *         does not exist.
	 */
	 ...
	 * 
	 * @return array the configuration of the currently installed modules
	 *         (module ID => configuration)
	 */
	 ...
	 *
	 * Call this method to declare sub-modules and configure them with their
	 * initial property values.
	 * The parameter should be an array of module configurations. Each array
	 * element represents a single module,
	 * which can be either a string representing the module ID or an
	 * ID-configuration pair representing
	 ...
	 * You may override this default by explicitly specifying the 'class' option
	 * in the configuration.
	 *
	 * You may also enable or disable a module by specifying the 'enabled'
	 ...
	 * @return boolean whether the named application component exists (including
	 ...
	 * @return IApplicationComponent the application component instance, null if
	 *         the application component is disabled or does not exist.
	 * @see hasComponent
	 */
	 ...
	 * The component will be initialized by calling its {@link
	 * CApplicationComponent::init() init()}
	 ...
	 *        	(either configuration array or instance). If this parameter is
	 *        	null,
	 *        	component will be unloaded from the module.
	 * @param boolean $merge
	 *        	whether to merge the new component configuration
	 *        	with the existing one. Defaults to true, meaning the
	 *        	previously registered
	 *        	component configuration with the same ID will be merged with
	 *        	the new configuration.
	 *        	If set to false, the existing configuration will be replaced
	 *        	completely.
	...
	public function setComponent($id, $component, $merge = true) {
		if ($component === null) {
			...
			if (isset ( $component ['class'] ) && get_class ( $this->_components [$id] ) !== $component ['class']) {
				unset ( $this->_components [$id] );
				$this->_componentConfig [$id] = $component; // we should ignore merge
				                                         // here
				return;
			}
	 ...
	 *        	whether to return the loaded components only. If this is set
	 *        	false,
	 ...
	 * a component can be enabled (default) or disabled by specifying the
	 * 'enabled' value
	 * in the configuration.
	 *
	 * If a configuration is specified with an ID that is the same as an
	 * existing
	 ...
	 *        	application components(id=>component configuration or
	 *        	instances)
	 * @param boolean $merge
	 *        	whether to merge the new component configuration with the
	 *        	existing one.
	 *        	Defaults to true, meaning the previously registered component
	 *        	configuration of the same ID
	 *        	will be merged with the new configuration. If false, the
	 *        	existing configuration will be replaced completely.
	 */
	 ...
	 * You may override this method to do some customized preinitialization
	 * work.
