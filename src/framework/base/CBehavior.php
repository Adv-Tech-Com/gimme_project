 ...
 *
 * @property CComponent $owner The owner component that this behavior is
 *           attached to.
...
class CBehavior extends CComponent implements IBehavior {
	 ...
	 * methods by the behavior class. The handlers will be attached to the
	 * corresponding
	 * events when the behavior is attached to the {@link owner} component; and
	 * they
	 ...
	 * Make sure you've declared handler as public and call the parent
