...
<body>
	<div id="page">
		...
		<div id="content">
			<h2>Beskrivelse</h2>
			<p>
				Dette skriptet sjekker om serverkonfigurasjonen oppfyller kravene
				for å kjøre <a href="http://www.yiiframework.com/">Yii</a>-applikasjoner.
				Det sjekker om serveren kjører riktig versjon av PHP, om
				nødvendige extensions er lastet og om PHP-innstillingene i php.ini
				er korrekt.
			</p>
...
<tr>
	...
	<?php echo $requirement[0]; ?>
					...
					<td
						class="<?php echo $requirement[2] ? 'ok' : ($requirement[1] ? 'feil' : 'advarsel'); ?>">
