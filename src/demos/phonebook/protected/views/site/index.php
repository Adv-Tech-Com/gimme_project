...
<body>
	...
	<p>This demo shows how to use Yii to implement a Web service used by an
		Adobe Flex 3.0 client.</p>

	<p>In order to see this demo, the PHP SOAP extension must be enabled
		and your browser should have installed Adobe Flash Player version 9 or
		above.</p>
