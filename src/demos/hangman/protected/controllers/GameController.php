...
/**
 * GameController implements the {@link
 * http://en.wikipedia.org/wiki/Hangman_(game) Hangman game}.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
...
class GameController extends CController {
	...
	public function actionPlay() {
		...
		if (isset ( $_POST ['level'] ) && isset ( $levels [$_POST ['level']] )) {
			...
			$params = array (
					'levels' => $levels,
					// if this is a POST request, it means the level is not
					// chosen
	 ...
	 *
	 * @param
	 *        	integer the difficulty level. This value is persistent
	 *        	during the whole game session.
	 */
	 ...
	 *
	 * @param
	 *        	string the word to be guessed. This value is persistent
	 *        	during the whole game session.
	 */
	 ...
	 *
	 * @param
	 *        	string the word being guessed. This value is persistent
	 *        	during the whole game session.
	 */
	 ...
	 *
	 * @param
	 *        	integer the number of misses. This value is persistent
	 *        	during the whole game session.
	 */
